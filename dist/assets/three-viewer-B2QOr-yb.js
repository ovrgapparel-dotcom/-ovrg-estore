...
`)+`
`+f);const y=_+p+a,M=_+f+o,A=Ml(s,s.VERTEX_SHADER,y),E=Ml(s,s.FRAGMENT_SHADER,M);s.attachShader(v,A),s.attachShader(v,E),t.index0AttributeName!==void 0?s.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(v,0,"position"),s.linkProgram(v);function w(P){if(i.debug.checkShaderErrors){const B=s.getProgramInfoLog(v)||"",V=s.getShaderInfoLog(A)||"",q=s.getShaderInfoLog(E)||"",C=B.trim(),O=V.trim(),N=q.trim();let J=!0,Z=!0;if(s.getProgramParameter(v,s.LINK_STATUS)===!1)if(J=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,v,A,E);else{const te=yl(s,A,"vertex"),pe=yl(s,E,"fragment");Ce("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(v,s.VALIDATE_STATUS)+`
...
}`,k_=[new L(1,0,0),new L(-1,0,0),new L(0,1,0),new L(0,-1,0),new L(0,0,1),new L(0,0,-1)],B_=[new L(0,-1,0),new L(0,-1,0),new L(0,0,1),new L(0,0,-1),new L(0,-1,0),new L(0,-1,0)],Dl=new Oe,ms=new L,ga=new L;function z_(i,e,t){let n=new Ho;const s=new Pe,r=new Pe,a=new at,o=new yu,c=new Eu,l={},d=t.maxTextureSize,h={[Hn]:Gt,[Gt]:Hn,[xn]:xn},u=new Rn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Pe},radius:{value:4}},vertexShader:U_,fragmentShader:O_}),m=u.clone();m.defines.HORIZONTAL_PASS=1;const g=new Wt;g.setAttribute("position",new Lt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new Bt(g,u),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=cr;let f=this.type;this.render=function(E,w,b){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||E.length===0)return;this.type===Gh&&(ye("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=cr);const R=i.getRenderTarget(),I=i.getActiveCubeFace(),P=i.getActiveMipmapLevel(),B=i.state;B.setBlending(zn),B.buffers.depth.getReversed()===!0?B.buffers.color.setClear(0,0,0,0):B.buffers.color.setClear(1,1,1,1),B.buffers.depth.setTest(!0),B.setScissorTest(!1);const V=f!==this.type;V&&w.traverse(function(q){q.material&&(Array.isArray(q.material)?q.material.forEach(C=>C.needsUpdate=!0):q.material.needsUpdate=!0)});for(let q=0,C=E.length;q<C;q++){const O=E[q],N=O.shadow;if(N===void 0){ye("WebGLShadowMap:",O,"has no shadow.");continue}if(N.autoUpdate===!1&&N.needsUpdate===!1)continue;s.copy(N.mapSize);const J=N.getFrameExtents();s.multiply(J),r.copy(N.mapSize),(s.x>d||s.y>d)&&(s.x>d&&(r.x=Math.floor(d/J.x),s.x=r.x*J.x,N.mapSize.x=r.x),s.y>d&&(r.y=Math.floor(d/J.y),s.y=r.y*J.y,N.mapSize.y=r.y));const Z=i.state.buffers.depth.getReversed();if(N.camera._reversedDepth=Z,N.map===null||V===!0){if(N.map!==null&&(N.map.depthTexture!==null&&(N.map.depthTexture.dispose(),N.map.depthTexture=null),N.map.dispose()),this.type===_s){if(O.isPointLight){ye("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}N.map=new En(s.x,s.y,{format:vi,type:Vn,minFilter:Et,magFilter:Et,generateMipmaps:!1}),N.map.texture.name=O.name+".shadowMap",N.map.depthTexture=new Ji(s.x,s.y,sn),N.map.depthTexture.name=O.name+".shadowMapDepth",N.map.depthTexture.format=Wn,N.map.depthTexture.compareFunction=null,N.map.depthTexture.minFilter=yt,N.map.depthTexture.magFilter=yt}else O.isPointLight?(N.map=new Mh(s.x),N.map.depthTexture=new _u(s.x,An)):(N.map=new En(s.x,s.y),N.map.depthTexture=new Ji(s.x,s.y,An)),N.map.depthTexture.name=O.name+".shadowMap",N.map.depthTexture.format=Wn,this.type===cr?(N.map.depthTexture.compareFunction=Z?Uo:No,N.map.depthTexture.minFilter=Et,N.map.depthTexture.magFilter=Et):(N.map.depthTexture.compareFunction=null,N.map.depthTexture.minFilter=yt,N.map.depthTexture.magFilter=yt);N.camera.updateProjectionMatrix()}const te=N.map.isWebGLCubeRenderTarget?6:1;for(let pe=0;pe<te;pe++){if(N.map.isWebGLCubeRenderTarget)i.setRenderTarget(N.map,pe),i.clear();else{pe===0&&(i.setRenderTarget(N.map),i.clear());const xe=N.getViewport(pe);a.set(r.x*xe.x,r.y*xe.y,r.x*xe.z,r.y*xe.w),B.viewport(a)}if(O.isPointLight){const xe=N.camera,Le=N.matrix,Ke=O.distance||xe.far;Ke!==xe.far&&(xe.far=Ke,xe.updateProjectionMatrix()),ms.setFromMatrixPosition(O.matrixWorld),xe.position.copy(ms),ga.copy(xe.position),ga.add(k_[pe]),xe.up.copy(B_[pe]),xe.lookAt(ga),xe.updateMatrixWorld(),Le.makeTranslation(-ms.x,-ms.y,-ms.z),Dl.multiplyMatrices(xe.projectionMatrix,xe.matrixWorldInverse),N._frustum.setFromProjectionMatrix(Dl,xe.coordinateSystem,xe.reversedDepth)}else N.updateMatrices(O);n=N.getFrustum(),M(w,b,N.camera,O,this.type)}N.isPointLightShadow!==!0&&this.type===_s&&_(N,b),N.needsUpdate=!1}f=this.type,p.needsUpdate=!1,i.setRenderTarget(R,I,P)};function _(E,w){const b=e.update(v);u.defines.VSM_SAMPLES!==E.blurSamples&&(u.defines.VSM_SAMPLES=E.blurSamples,m.defines.VSM_SAMPLES=E.blurSamples,u.needsUpdate=!0,m.needsUpdate=!0),E.mapPass===null&&(E.mapPass=new En(s.x,s.y,{format:vi,type:Vn})),u.uniforms.shadow_pass.value=E.map.depthTexture,u.uniforms.resolution.value=E.mapSize,u.uniforms.radius.value=E.radius,i.setRenderTarget(E.mapPass),i.clear(),i.renderBufferDirect(w,null,b,u,v,null),m.uniforms.shadow_pass.value=E.mapPass.texture,m.uniforms.resolution.value=E.mapSize,m.uniforms.radius.value=E.radius,i.setRenderTarget(E.map),i.clear(),i.renderBufferDirect(w,null,b,m,v,null)}function y(E,w,b,R){let I=null;const P=b.isPointLight===!0?E.customDistanceMaterial:E.customDepthMaterial;if(P!==void 0)I=P;else if(I=b.isPointLight===!0?c:o,i.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0||w.alphaToCoverage===!0){const B=I.uuid,V=w.uuid;let q=l[B];q===void 0&&(q={},l[B]=q);let C=q[V];C===void 0&&(C=I.clone(),q[V]=C,w.addEventListener("dispose",A)),I=C}if(I.visible=w.visible,I.wireframe=w.wireframe,R===_s?I.side=w.shadowSide!==null?w.shadowSide:w.side:I.side=w.shadowSide!==null?w.shadowSide:h[w.side],I.alphaMap=w.alphaMap,I.alphaTest=w.alphaToCoverage===!0?.5:w.alphaTest,I.map=w.map,I.clipShadows=w.clipShadows,I.clippingPlanes=w.clippingPlanes,I.clipIntersection=w.clipIntersection,I.displacementMap=w.displacementMap,I.displacementScale=w.displacementScale,I.displacementBias=w.displacementBias,I.wireframeLinewidth=w.wireframeLinewidth,I.linewidth=w.linewidth,b.isPointLight===!0&&I.isMeshDistanceMaterial===!0){const B=i.properties.get(I);B.light=b}return I}function M(E,w,b,R,I){if(E.visible===!1)return;if(E.layers.test(w.layers)&&(E.isMesh||E.isLine||E.isPoints)&&(E.castShadow||E.receiveShadow&&I===_s)&&(!E.frustumCulled||n.intersectsObject(E))){E.modelViewMatrix.multiplyMatrices(b.matrixWorldInverse,E.matrixWorld);const V=e.update(E),q=E.material;if(Array.isArray(q)){const C=V.groups;for(let O=0,N=C.length;O<N;O++){const J=C[O],Z=q[J.materialIndex];if(Z&&Z.visible){const te=y(E,Z,R,I);E.onBeforeShadow(i,E,w,b,V,te,J),i.renderBufferDirect(b,null,V,te,E,J),E.onAfterShadow(i,E,w,b,V,te,J)}}}else if(q.visible){const C=y(E,q,R,I);E.onBeforeShadow(i,E,w,b,V,C,null),i.renderBufferDirect(b,null,V,C,E,null),E.onAfterShadow(i,E,w,b,V,C,null)}}const B=E.children;for(let V=0,q=B.length;V<q;V++)M(B[V],w,b,R,I)}function A(E){E.target.removeEventListener("dispose",A);for(const b in l){const R=l[b],I=E.target.uuid;I in R&&(R[I].dispose(),delete R[I])}}}function G_(i,e){function t(){let D=!1;const se=new at;let j=null;const me=new at(0,0,0,0);return{setMask:function(ae){j!==ae&&!D&&(i.colorMask(ae,ae,ae,ae),j=ae)},setLocked:function(ae){D=ae},setClear:function(ae,$,Te,Ne,mt){mt===!0&&(ae*=Ne,$*=Ne,Te*=Ne),se.set(ae,$,Te,Ne),me.equals(se)===!1&&(i.clearColor(ae,$,Te,Ne),me.copy(se))},reset:function(){D=!1,j=null,me.set(-1,0,0,0)}}}function n(){let D=!1,se=!1,j=null,me=null,ae=null;return{setReversed:function($){if(se!==$){const Te=e.get("EXT_clip_control");$?Te.clipControlEXT(Te.LOWER_LEFT_EXT,Te.ZERO_TO_ONE_EXT):Te.clipControlEXT(Te.LOWER_LEFT_EXT,Te.NEGATIVE_ONE_TO_ONE_EXT),se=$;const Ne=ae;ae=null,this.setClear(Ne)}},getReversed:function(){return se},setTest:function($){$?ee(i.DEPTH_TEST):Me(i.DEPTH_TEST)},setMask:function($){j!==$&&!D&&(i.depthMask($),j=$)},setFunc:function($){if(se&&($=yd[$]),me!==$){switch($){case wa:i.depthFunc(i.NEVER);break;case Ra:i.depthFunc(i.ALWAYS);break;case Ca:i.depthFunc(i.LESS);break;case Xi:i.depthFunc(i.LEQUAL);break;case Pa:i.depthFunc(i.EQUAL);break;case Da:i.depthFunc(i.GEQUAL);break;case La:i.depthFunc(i.GREATER);break;case Ia:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}me=$}},setLocked:function($){D=$},setClear:function($){ae!==$&&(ae=$,se&&($=1-$),i.clearDepth($))},reset:function(){D=!1,j=null,me=null,ae=null,se=!1}}}function s(){let D=!1,se=null,j=null,me=null,ae=null,$=null,Te=null,Ne=null,mt=null;return{setTest:function(tt){D||(tt?ee(i.STENCIL_TEST):Me(i.STENCIL_TEST))},setMask:function(tt){se!==tt&&!D&&(i.stencilMask(tt),se=tt)},setFunc:function(tt,Dn,fn){(j!==tt||me!==Dn||ae!==fn)&&(i.stencilFunc(tt,Dn,fn),j=tt,me=Dn,ae=fn)},setOp:function(tt,Dn,fn){($!==tt||Te!==Dn||Ne!==fn)&&(i.stencilOp(tt,Dn,fn),$=tt,Te=Dn,Ne=fn)},setLocked:function(tt){D=tt},setClear:function(tt){mt!==tt&&(i.clearStencil(tt),mt=tt)},reset:function(){D=!1,se=null,j=null,me=null,ae=null,$=null,Te=null,Ne=null,mt=null}}}const r=new t,a=new n,o=new s,c=new WeakMap,l=new WeakMap;let d={},h={},u={},m=new WeakMap,g=[],v=null,p=!1,f=null,_=null,y=null,M=null,A=null,E=null,w=null,b=new De(0,0,0),R=0,I=!1,P=null,B=null,V=null,q=null,C=null;const O=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let N=!1,J=0;const Z=i.getParameter(i.VERSION);Z.indexOf("WebGL")!==-1?(J=parseFloat(/^WebGL (\d)/.exec(Z)[1]),N=J>=1):Z.indexOf("OpenGL ES")!==-1&&(J=parseFloat(/^OpenGL ES (\d)/.exec(Z)[1]),N=J>=2);let te=null,pe={};const xe=i.getParameter(i.SCISSOR_BOX),Le=i.getParameter(i.VIEWPORT),Ke=new at().fromArray(xe),Re=new at().fromArray(Le);function X(D,se,j,me){const ae=new Uint8Array(4),$=i.createTexture();i.bindTexture(D,$),i.texParameteri(D,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(D,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Te=0;Te<j;Te++)D===i.TEXTURE_3D||D===i.TEXTURE_2D_ARRAY?i.texImage3D(se,0,i.RGBA,1,1,me,0,i.RGBA,i.UNSIGNED_BYTE,ae):i.texImage2D(se+Te,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,ae);return $}const oe={};oe[i.TEXTURE_2D]=X(i.TEXTURE_2D,i.TEXTURE_2D,1),oe[i.TEXTURE_CUBE_MAP]=X(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),oe[i.TEXTURE_2D_ARRAY]=X(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),oe[i.TEXTURE_3D]=X(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),ee(i.DEPTH_TEST),a.setFunc(Xi),vt(!1),ht(hc),ee(i.CULL_FACE),lt(zn);function ee(D){d[D]!==!0&&(i.enable(D),d[D]=!0)}function Me(D){d[D]!==!1&&(i.disable(D),d[D]=!1)}function ve(D,se){return u[D]!==se?(i.bindFramebuffer(D,se),u[D]=se,D===i.DRAW_FRAMEBUFFER&&(u[i.FRAMEBUFFER]=se),D===i.FRAMEBUFFER&&(u[i.DRAW_FRAMEBUFFER]=se),!0):!1}function Ee(D,se){let j=g,me=!1;if(D){j=m.get(se),j===void 0&&(j=[],m.set(se,j));const ae=D.textures;if(j.length!==ae.length||j[0]!==i.COLOR_ATTACHMENT0){for(let $=0,Te=ae.length;$<Te;$++)j[$]=i.COLOR_ATTACHMENT0+$;j.length=ae.length,me=!0}}else j[0]!==i.BACK&&(j[0]=i.BACK,me=!0);me&&i.drawBuffers(j)}function Ve(D){return v!==D?(i.useProgram(D),v=D,!0):!1}const ke={[ui]:i.FUNC_ADD,[Vh]:i.FUNC_SUBTRACT,[Wh]:i.FUNC_REVERSE_SUBTRACT};ke[jh]=i.MIN,ke[Xh]=i.MAX;const Ze={[qh]:i.ZERO,[Kh]:i.ONE,[Yh]:i.SRC_COLOR,[Ta]:i.SRC_ALPHA,[td]:i.SRC_ALPHA_SATURATE,[Qh]:i.DST_COLOR,[Zh]:i.DST_ALPHA,[Jh]:i.ONE_MINUS_SRC_COLOR,[Aa]:i.ONE_MINUS_SRC_ALPHA,[ed]:i.ONE_MINUS_DST_COLOR,[$h]:i.ONE_MINUS_DST_ALPHA,[nd]:i.CONSTANT_COLOR,[id]:i.ONE_MINUS_CONSTANT_COLOR,[sd]:i.CONSTANT_ALPHA,[rd]:i.ONE_MINUS_CONSTANT_ALPHA};function lt(D,se,j,me,ae,$,Te,Ne,mt,tt){if(D===zn){p===!0&&(Me(i.BLEND),p=!1);return}if(p===!1&&(ee(i.BLEND),p=!0),D!==Hh){if(D!==f||tt!==I){if((_!==ui||A!==ui)&&(i.blendEquation(i.FUNC_ADD),_=ui,A=ui),tt)switch(D){case Hi:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case dc:i.blendFunc(i.ONE,i.ONE);break;case uc:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case fc:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:Ce("WebGLState: Invalid blending: ",D);break}else switch(D){case Hi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case dc:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case uc:Ce("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case fc:Ce("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Ce("WebGLState: Invalid blending: ",D);break}y=null,M=null,E=null,w=null,b.set(0,0,0),R=0,f=D,I=tt}return}ae=ae||se,$=$||j,Te=Te||me,(se!==_||ae!==A)&&(i.blendEquationSeparate(ke[se],ke[ae]),_=se,A=ae),(j!==y||me!==M||$!==E||Te!==w)&&(i.blendFuncSeparate(Ze[j],Ze[me],Ze[$],Ze[Te]),y=j,M=me,E=$,w=Te),(Ne.equals(b)===!1||mt!==R)&&(i.blendColor(Ne.r,Ne.g,Ne.b,mt),b.copy(Ne),R=mt),f=D,I=!1}function Xe(D,se){D.side===xn?Me(i.CULL_FACE):ee(i.CULL_FACE);let j=D.side===Gt;se&&(j=!j),vt(j),D.blending===Hi&&D.transparent===!1?lt(zn):lt(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.blendColor,D.blendAlpha,D.premultipliedAlpha),a.setFunc(D.depthFunc),a.setTest(D.depthTest),a.setMask(D.depthWrite),r.setMask(D.colorWrite);const me=D.stencilWrite;o.setTest(me),me&&(o.setMask(D.stencilWriteMask),o.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),o.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),F(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?ee(i.SAMPLE_ALPHA_TO_COVERAGE):Me(i.SAMPLE_ALPHA_TO_COVERAGE)}function vt(D){P!==D&&(D?i.frontFace(i.CW):i.frontFace(i.CCW),P=D)}function ht(D){D!==Bh?(ee(i.CULL_FACE),D!==B&&(D===hc?i.cullFace(i.BACK):D===zh?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):Me(i.CULL_FACE),B=D}function jt(D){D!==V&&(N&&i.lineWidth(D),V=D)}function F(D,se,j){D?(ee(i.POLYGON_OFFSET_FILL),(q!==se||C!==j)&&(q=se,C=j,a.getReversed()&&(se=-se),i.polygonOffset(se,j))):Me(i.POLYGON_OFFSET_FILL)}function Mt(D){D?ee(i.SCISSOR_TEST):Me(i.SCISSOR_TEST)}function qe(D){D===void 0&&(D=i.TEXTURE0+O-1),te!==D&&(i.activeTexture(D),te=D)}function ot(D,se,j){j===void 0&&(te===null?j=i.TEXTURE0+O-1:j=te);let me=pe[j];me===void 0&&(me={type:void 0,texture:void 0},pe[j]=me),(me.type!==D||me.texture!==se)&&(te!==j&&(i.activeTexture(j),te=j),i.bindTexture(D,se||oe[D]),me.type=D,me.texture=se)}function le(){const D=pe[te];D!==void 0&&D.type!==void 0&&(i.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function ft(){try{i.compressedTexImage2D(...arguments)}catch(D){Ce("WebGLState:",D)}}function T(){try{i.compressedTexImage3D(...arguments)}catch(D){Ce("WebGLState:",D)}}function x(){try{i.texSubImage2D(...arguments)}catch(D){Ce("WebGLState:",D)}}function k(){try{i.texSubImage3D(...arguments)}catch(D){Ce("WebGLState:",D)}}function K(){try{i.compressedTexSubImage2D(...arguments)}catch(D){Ce("WebGLState:",D)}}function Q(){try{i.compressedTexSubImage3D(...arguments)}catch(D){Ce("WebGLState:",D)}}function ne(){try{i.texStorage2D(...arguments)}catch(D){Ce("WebGLState:",D)}}function ce(){try{i.texStorage3D(...arguments)}catch(D){Ce("WebGLState:",D)}}function W(){try{i.texImage2D(...arguments)}catch(D){Ce("WebGLState:",D)}}function Y(){try{i.texImage3D(...arguments)}catch(D){Ce("WebGLState:",D)}}function fe(D){return h[D]!==void 0?h[D]:i.getParameter(D)}function _e(D,se){h[D]!==se&&(i.pixelStorei(D,se),h[D]=se)}function re(D){Ke.equals(D)===!1&&(i.scissor(D.x,D.y,D.z,D.w),Ke.copy(D))}function ie(D){Re.equals(D)===!1&&(i.viewport(D.x,D.y,D.z,D.w),Re.copy(D))}function Ie(D,se){let j=l.get(se);j===void 0&&(j=new WeakMap,l.set(se,j));let me=j.get(D);me===void 0&&(me=i.getUniformBlockIndex(se,D.name),j.set(D,me))}function Be(D,se){const me=l.get(se).get(D);c.get(se)!==me&&(i.uniformBlockBinding(se,me,D.__bindingPointIndex),c.set(se,me))}function Je(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),i.pixelStorei(i.PACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,!1),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.BROWSER_DEFAULT_WEBGL),i.pixelStorei(i.PACK_ROW_LENGTH,0),i.pixelStorei(i.PACK_SKIP_PIXELS,0),i.pixelStorei(i.PACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_ROW_LENGTH,0),i.pixelStorei(i.UNPACK_IMAGE_HEIGHT,0),i.pixelStorei(i.UNPACK_SKIP_PIXELS,0),i.pixelStorei(i.UNPACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_SKIP_IMAGES,0),d={},h={},te=null,pe={},u={},m=new WeakMap,g=[],v=null,p=!1,f=null,_=null,y=null,M=null,A=null,E=null,w=null,b=new De(0,0,0),R=0,I=!1,P=null,B=null,V=null,q=null,C=null,Ke.set(0,0,i.canvas.width,i.canvas.height),Re.set(0,0,i.canvas.width,i.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:ee,disable:Me,bindFramebuffer:ve,drawBuffers:Ee,useProgram:Ve,setBlending:lt,setMaterial:Xe,setFlipSided:vt,setCullFace:ht,setLineWidth:jt,setPolygonOffset:F,setScissorTest:Mt,activeTexture:qe,bindTexture:ot,unbindTexture:le,compressedTexImage2D:ft,compressedTexImage3D:T,texImage2D:W,texImage3D:Y,pixelStorei:_e,getParameter:fe,updateUBOMapping:Ie,uniformBlockBinding:Be,texStorage2D:ne,texStorage3D:ce,texSubImage2D:x,texSubImage3D:k,compressedTexSubImage2D:K,compressedTexSubImage3D:Q,scissor:re,viewport:ie,reset:Je}}function H_(i,e,t,n,s,r,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new Pe,d=new WeakMap,h=new Set;let u;const m=new WeakMap;let g=!1;try{g=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function v(T,x){return g?new OffscreenCanvas(T,x):Cs("canvas")}function p(T,x,k){let K=1;const Q=ft(T);if((Q.width>k||Q.height>k)&&(K=k/Math.max(Q.width,Q.height)),K<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){const ne=Math.floor(K*Q.width),ce=Math.floor(K*Q.height);u===void 0&&(u=v(ne,ce));const W=x?v(ne,ce):u;return W.width=ne,W.height=ce,W.getContext("2d").drawImage(T,0,0,ne,ce),ye("WebGLRenderer: Texture has been resized from ("+Q.width+"x"+Q.height+") to ("+ne+"x"+ce+")."),W}else return"data"in T&&ye("WebGLRenderer: Image in DataTexture is too big ("+Q.width+"x"+Q.height+")."),T;return T}function f(T){return T.generateMipmaps}function _(T){i.generateMipmap(T)}function y(T){return T.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:T.isWebGL3DRenderTarget?i.TEXTURE_3D:T.isWebGLArrayRenderTarget||T.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function M(T,x,k,K,Q,ne=!1){if(T!==null){if(i[T]!==void 0)return i[T];ye("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let ce;K&&(ce=e.get("EXT_texture_norm16"),ce||ye("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let W=x;if(x===i.RED&&(k===i.FLOAT&&(W=i.R32F),k===i.HALF_FLOAT&&(W=i.R16F),k===i.UNSIGNED_BYTE&&(W=i.R8),k===i.UNSIGNED_SHORT&&ce&&(W=ce.R16_EXT),k===i.SHORT&&ce&&(W=ce.R16_SNORM_EXT)),x===i.RED_INTEGER&&(k===i.UNSIGNED_BYTE&&(W=i.R8UI),k===i.UNSIGNED_SHORT&&(W=i.R16UI),k===i.UNSIGNED_INT&&(W=i.R32UI),k===i.BYTE&&(W=i.R8I),k===i.SHORT&&(W=i.R16I),k===i.INT&&(W=i.R32I)),x===i.RG&&(k===i.FLOAT&&(W=i.RG32F),k===i.HALF_FLOAT&&(W=i.RG16F),k===i.UNSIGNED_BYTE&&(W=i.RG8),k===i.UNSIGNED_SHORT&&ce&&(W=ce.RG16_EXT),k===i.SHORT&&ce&&(W=ce.RG16_SNORM_EXT)),x===i.RG_INTEGER&&(k===i.UNSIGNED_BYTE&&(W=i.RG8UI),k===i.UNSIGNED_SHORT&&(W=i.RG16UI),k===i.UNSIGNED_INT&&(W=i.RG32UI),k===i.BYTE&&(W=i.RG8I),k===i.SHORT&&(W=i.RG16I),k===i.INT&&(W=i.RG32I)),x===i.RGB_INTEGER&&(k===i.UNSIGNED_BYTE&&(W=i.RGB8UI),k===i.UNSIGNED_SHORT&&(W=i.RGB16UI),k===i.UNSIGNED_INT&&(W=i.RGB32UI),k===i.BYTE&&(W=i.RGB8I),k===i.SHORT&&(W=i.RGB16I),k===i.INT&&(W=i.RGB32I)),x===i.RGBA_INTEGER&&(k===i.UNSIGNED_BYTE&&(W=i.RGBA8UI),k===i.UNSIGNED_SHORT&&(W=i.RGBA16UI),k===i.UNSIGNED_INT&&(W=i.RGBA32UI),k===i.BYTE&&(W=i.RGBA8I),k===i.SHORT&&(W=i.RGBA16I),k===i.INT&&(W=i.RGBA32I)),x===i.RGB&&(k===i.UNSIGNED_SHORT&&ce&&(W=ce.RGB16_EXT),k===i.SHORT&&ce&&(W=ce.RGB16_SNORM_EXT),k===i.UNSIGNED_INT_5_9_9_9_REV&&(W=i.RGB9_E5),k===i.UNSIGNED_INT_10F_11F_11F_REV&&(W=i.R11F_G11F_B10F)),x===i.RGBA){const Y=ne?xr:We.getTransfer(Q);k===i.FLOAT&&(W=i.RGBA32F),k===i.HALF_FLOAT&&(W=i.RGBA16F),k===i.UNSIGNED_BYTE&&(W=Y===$e?i.SRGB8_ALPHA8:i.RGBA8),k===i.UNSIGNED_SHORT&&ce&&(W=ce.RGBA16_EXT),k===i.SHORT&&ce&&(W=ce.RGBA16_SNORM_EXT),k===i.UNSIGNED_SHORT_4_4_4_4&&(W=i.RGBA4),k===i.UNSIGNED_SHORT_5_5_5_1&&(W=i.RGB5_A1)}return(W===i.R16F||W===i.R32F||W===i.RG16F||W===i.RG32F||W===i.RGBA16F||W===i.RGBA32F)&&e.get("EXT_color_buffer_float"),W}function A(T,x){let k;return T?x===null||x===An||x===Ts?k=i.DEPTH24_STENCIL8:x===sn?k=i.DEPTH32F_STENCIL8:x===Es&&(k=i.DEPTH24_STENCIL8,ye("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):x===null||x===An||x===Ts?k=i.DEPTH_COMPONENT24:x===sn?k=i.DEPTH_COMPONENT32F:x===Es&&(k=i.DEPTH_COMPONENT16),k}function E(T,x){return f(T)===!0||T.isFramebufferTexture&&T.minFilter!==yt&&T.minFilter!==Et?Math.log2(Math.max(x.width,x.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?x.mipmaps.length:1}function w(T){const x=T.target;x.removeEventListener("dispose",w),R(x),x.isVideoTexture&&d.delete(x),x.isHTMLTexture&&h.delete(x)}function b(T){const x=T.target;x.removeEventListener("dispose",b),P(x)}function R(T){const x=n.get(T);if(x.__webglInit===void 0)return;const k=T.source,K=m.get(k);if(K){const Q=K[x.__cacheKey];Q.usedTimes--,Q.usedTimes===0&&I(T),Object.keys(K).length===0&&m.delete(k)}n.remove(T)}function I(T){const x=n.get(T);i.deleteTexture(x.__webglTexture);const k=T.source,K=m.get(k);delete K[x.__cacheKey],a.memory.textures--}function P(T){const x=n.get(T);if(T.depthTexture&&(T.depthTexture.dispose(),n.remove(T.depthTexture)),T.isWebGLCubeRenderTarget)for(let K=0;K<6;K++){if(Array.isArray(x.__webglFramebuffer[K]))for(let Q=0;Q<x.__webglFramebuffer[K].length;Q++)i.deleteFramebuffer(x.__webglFramebuffer[K][Q]);else i.deleteFramebuffer(x.__webglFramebuffer[K]);x.__webglDepthbuffer&&i.deleteRenderbuffer(x.__webglDepthbuffer[K])}else{if(Array.isArray(x.__webglFramebuffer))for(let K=0;K<x.__webglFramebuffer.length;K++)i.deleteFramebuffer(x.__webglFramebuffer[K]);else i.deleteFramebuffer(x.__webglFramebuffer);if(x.__webglDepthbuffer&&i.deleteRenderbuffer(x.__webglDepthbuffer),x.__webglMultisampledFramebuffer&&i.deleteFramebuffer(x.__webglMultisampledFramebuffer),x.__webglColorRenderbuffer)for(let K=0;K<x.__webglColorRenderbuffer.length;K++)x.__webglColorRenderbuffer[K]&&i.deleteRenderbuffer(x.__webglColorRenderbuffer[K]);x.__webglDepthRenderbuffer&&i.deleteRenderbuffer(x.__webglDepthRenderbuffer)}const k=T.textures;for(let K=0,Q=k.length;K<Q;K++){const ne=n.get(k[K]);ne.__webglTexture&&(i.deleteTexture(ne.__webglTexture),a.memory.textures--),n.remove(k[K])}n.remove(T)}let B=0;function V(){B=0}function q(){return B}function C(T){B=T}function O(){const T=B;return T>=s.maxTextures&&ye("WebGLTextures: Trying to use "+T+" texture units while this GPU supports only "+s.maxTextures),B+=1,T}function N(T){const x=[];return x.push(T.wrapS),x.push(T.wrapT),x.push(T.wrapR||0),x.push(T.magFilter),x.push(T.minFilter),x.push(T.anisotropy),x.push(T.internalFormat),x.push(T.format),x.push(T.type),x.push(T.generateMipmaps),x.push(T.premultiplyAlpha),x.push(T.flipY),x.push(T.unpackAlignment),x.push(T.colorSpace),x.join()}function J(T,x){const k=n.get(T);if(T.isVideoTexture&&ot(T),T.isRenderTargetTexture===!1&&T.isExternalTexture!==!0&&T.version>0&&k.__version!==T.version){const K=T.image;if(K===null)ye("WebGLRenderer: Texture marked for update but no image data found.");else if(K.complete===!1)ye("WebGLRenderer: Texture marked for update but image is incomplete");else{Me(k,T,x);return}}else T.isExternalTexture&&(k.__webglTexture=T.sourceTexture?T.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,k.__webglTexture,i.TEXTURE0+x)}function Z(T,x){const k=n.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&k.__version!==T.version){Me(k,T,x);return}else T.isExternalTexture&&(k.__webglTexture=T.sourceTexture?T.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,k.__webglTexture,i.TEXTURE0+x)}function te(T,x){const k=n.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&k.__version!==T.version){Me(k,T,x);return}t.bindTexture(i.TEXTURE_3D,k.__webglTexture,i.TEXTURE0+x)}function pe(T,x){const k=n.get(T);if(T.isCubeDepthTexture!==!0&&T.version>0&&k.__version!==T.version){ve(k,T,x);return}t.bindTexture(i.TEXTURE_CUBE_MAP,k.__webglTexture,i.TEXTURE0+x)}const xe={[Ki]:i.REPEAT,[vn]:i.CLAMP_TO_EDGE,[gr]:i.MIRRORED_REPEAT},Le={[yt]:i.NEAREST,[Yl]:i.NEAREST_MIPMAP_NEAREST,[bs]:i.NEAREST_MIPMAP_LINEAR,[Et]:i.LINEAR,[lr]:i.LINEAR_MIPMAP_NEAREST,[kn]:i.LINEAR_MIPMAP_LINEAR},Ke={[fd]:i.NEVER,[bd]:i.ALWAYS,[pd]:i.LESS,[No]:i.LEQUAL,[md]:i.EQUAL,[Uo]:i.GEQUAL,[gd]:i.GREATER,[_d]:i.NOTEQUAL};function Re(T,x){if(x.type===sn&&e.has("OES_texture_float_linear")===!1&&(x.magFilter===Et||x.magFilter===lr||x.magFilter===bs||x.magFilter===kn||x.minFilter===Et||x.minFilter===lr||x.minFilter===bs||x.minFilter===kn)&&ye("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(T,i.TEXTURE_WRAP_S,xe[x.wrapS]),i.texParameteri(T,i.TEXTURE_WRAP_T,xe[x.wrapT]),(T===i.TEXTURE_3D||T===i.TEXTURE_2D_ARRAY)&&i.texParameteri(T,i.TEXTURE_WRAP_R,xe[x.wrapR]),i.texParameteri(T,i.TEXTURE_MAG_FILTER,Le[x.magFilter]),i.texParameteri(T,i.TEXTURE_MIN_FILTER,Le[x.minFilter]),x.compareFunction&&(i.texParameteri(T,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(T,i.TEXTURE_COMPARE_FUNC,Ke[x.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(x.magFilter===yt||x.minFilter!==bs&&x.minFilter!==kn||x.type===sn&&e.has("OES_texture_float_linear")===!1)return;if(x.anisotropy>1||n.get(x).__currentAnisotropy){const k=e.get("EXT_texture_filter_anisotropic");i.texParameterf(T,k.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(x.anisotropy,s.getMaxAnisotropy())),n.get(x).__currentAnisotropy=x.anisotropy}}}function X(T,x){let k=!1;T.__webglInit===void 0&&(T.__webglInit=!0,x.addEventListener("dispose",w));const K=x.source;let Q=m.get(K);Q===void 0&&(Q={},m.set(K,Q));const ne=N(x);if(ne!==T.__cacheKey){Q[ne]===void 0&&(Q[ne]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,k=!0),Q[ne].usedTimes++;const ce=Q[T.__cacheKey];ce!==void 0&&(Q[T.__cacheKey].usedTimes--,ce.usedTimes===0&&I(x)),T.__cacheKey=ne,T.__webglTexture=Q[ne].texture}return k}function oe(T,x,k){return Math.floor(Math.floor(T/k)/x)}function ee(T,x,k,K){const ne=T.updateRanges;if(ne.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,x.width,x.height,k,K,x.data);else{ne.sort((_e,re)=>_e.start-re.start);let ce=0;for(let _e=1;_e<ne.length;_e++){const re=ne[ce],ie=ne[_e],Ie=re.start+re.count,Be=oe(ie.start,x.width,4),Je=oe(re.start,x.width,4);ie.start<=Ie+1&&Be===Je&&oe(ie.start+ie.count-1,x.width,4)===Be?re.count=Math.max(re.count,ie.start+ie.count-re.start):(++ce,ne[ce]=ie)}ne.length=ce+1;const W=t.getParameter(i.UNPACK_ROW_LENGTH),Y=t.getParameter(i.UNPACK_SKIP_PIXELS),fe=t.getParameter(i.UNPACK_SKIP_ROWS);t.pixelStorei(i.UNPACK_ROW_LENGTH,x.width);for(let _e=0,re=ne.length;_e<re;_e++){const ie=ne[_e],Ie=Math.floor(ie.start/4),Be=Math.ceil(ie.count/4),Je=Ie%x.width,D=Math.floor(Ie/x.width),se=Be,j=1;t.pixelStorei(i.UNPACK_SKIP_PIXELS,Je),t.pixelStorei(i.UNPACK_SKIP_ROWS,D),t.texSubImage2D(i.TEXTURE_2D,0,Je,D,se,j,k,K,x.data)}T.clearUpdateRanges(),t.pixelStorei(i.UNPACK_ROW_LENGTH,W),t.pixelStorei(i.UNPACK_SKIP_PIXELS,Y),t.pixelStorei(i.UNPACK_SKIP_ROWS,fe)}}function Me(T,x,k){let K=i.TEXTURE_2D;(x.isDataArrayTexture||x.isCompressedArrayTexture)&&(K=i.TEXTURE_2D_ARRAY),x.isData3DTexture&&(K=i.TEXTURE_3D);const Q=X(T,x),ne=x.source;t.bindTexture(K,T.__webglTexture,i.TEXTURE0+k);const ce=n.get(ne);if(ne.version!==ce.__version||Q===!0){if(t.activeTexture(i.TEXTURE0+k),(typeof ImageBitmap<"u"&&x.image instanceof ImageBitmap)===!1){const j=We.getPrimaries(We.workingColorSpace),me=x.colorSpace===ni?null:We.getPrimaries(x.colorSpace),ae=x.colorSpace===ni||j===me?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,x.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,ae)}t.pixelStorei(i.UNPACK_ALIGNMENT,x.unpackAlignment);let Y=p(x.image,!1,s.maxTextureSize);Y=le(x,Y);const fe=r.convert(x.format,x.colorSpace),_e=r.convert(x.type);let re=M(x.internalFormat,fe,_e,x.normalized,x.colorSpace,x.isVideoTexture);Re(K,x);let ie;const Ie=x.mipmaps,Be=x.isVideoTexture!==!0,Je=ce.__version===void 0||Q===!0,D=ne.dataReady,se=E(x,Y);if(x.isDepthTexture)re=A(x.format===pi,x.type),Je&&(Be?t.texStorage2D(i.TEXTURE_2D,1,re,Y.width,Y.height):t.texImage2D(i.TEXTURE_2D,0,re,Y.width,Y.height,0,fe,_e,null));else if(x.isDataTexture)if(Ie.length>0){Be&&Je&&t.texStorage2D(i.TEXTURE_2D,se,re,Ie[0].width,Ie[0].height);for(let j=0,me=Ie.length;j<me;j++)ie=Ie[j],Be?D&&t.texSubImage2D(i.TEXTURE_2D,j,0,0,ie.width,ie.height,fe,_e,ie.data):t.texImage2D(i.TEXTURE_2D,j,re,ie.width,ie.height,0,fe,_e,ie.data);x.generateMipmaps=!1}else Be?(Je&&t.texStorage2D(i.TEXTURE_2D,se,re,Y.width,Y.height),D&&ee(x,Y,fe,_e)):t.texImage2D(i.TEXTURE_2D,0,re,Y.width,Y.height,0,fe,_e,Y.data);else if(x.isCompressedTexture)if(x.isCompressedArrayTexture){Be&&Je&&t.texStorage3D(i.TEXTURE_2D_ARRAY,se,re,Ie[0].width,Ie[0].height,Y.depth);for(let j=0,me=Ie.length;j<me;j++)if(ie=Ie[j],x.format!==rn)if(fe!==null)if(Be){if(D)if(x.layerUpdates.size>0){const ae=cl(ie.width,ie.height,x.format,x.type);for(const $ of x.layerUpdates){const Te=ie.data.subarray($*ae/ie.data.BYTES_PER_ELEMENT,($+1)*ae/ie.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,j,0,0,$,ie.width,ie.height,1,fe,Te)}x.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,j,0,0,0,ie.width,ie.height,Y.depth,fe,ie.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,j,re,ie.width,ie.height,Y.depth,0,ie.data,0,0);else ye("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Be?D&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,j,0,0,0,ie.width,ie.height,Y.depth,fe,_e,ie.data):t.texImage3D(i.TEXTURE_2D_ARRAY,j,re,ie.width,ie.height,Y.depth,0,fe,_e,ie.data)}else{Be&&Je&&t.texStorage2D(i.TEXTURE_2D,se,re,Ie[0].width,Ie[0].height);for(let j=0,me=Ie.length;j<me;j++)ie=Ie[j],x.format!==rn?fe!==null?Be?D&&t.compressedTexSubImage2D(i.TEXTURE_2D,j,0,0,ie.width,ie.height,fe,ie.data):t.compressedTexImage2D(i.TEXTURE_2D,j,re,ie.width,ie.height,0,ie.data):ye("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Be?D&&t.texSubImage2D(i.TEXTURE_2D,j,0,0,ie.width,ie.height,fe,_e,ie.data):t.texImage2D(i.TEXTURE_2D,j,re,ie.width,ie.height,0,fe,_e,ie.data)}else if(x.isDataArrayTexture)if(Be){if(Je&&t.texStorage3D(i.TEXTURE_2D_ARRAY,se,re,Y.width,Y.height,Y.depth),D)if(x.layerUpdates.size>0){const j=cl(Y.width,Y.height,x.format,x.type);for(const me of x.layerUpdates){const ae=Y.data.subarray(me*j/Y.data.BYTES_PER_ELEMENT,(me+1)*j/Y.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,me,Y.width,Y.height,1,fe,_e,ae)}x.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,Y.width,Y.height,Y.depth,fe,_e,Y.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,re,Y.width,Y.height,Y.depth,0,fe,_e,Y.data);else if(x.isData3DTexture)Be?(Je&&t.texStorage3D(i.TEXTURE_3D,se,re,Y.width,Y.height,Y.depth),D&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,Y.width,Y.height,Y.depth,fe,_e,Y.data)):t.texImage3D(i.TEXTURE_3D,0,re,Y.width,Y.height,Y.depth,0,fe,_e,Y.data);else if(x.isFramebufferTexture){if(Je)if(Be)t.texStorage2D(i.TEXTURE_2D,se,re,Y.width,Y.height);else{let j=Y.width,me=Y.height;for(let ae=0;ae<se;ae++)t.texImage2D(i.TEXTURE_2D,ae,re,j,me,0,fe,_e,null),j>>=1,me>>=1}}else if(x.isHTMLTexture){if("texElementImage2D"in i){const j=i.canvas;if(j.hasAttribute("layoutsubtree")||j.setAttribute("layoutsubtree","true"),Y.parentNode!==j){j.appendChild(Y),h.add(x),j.onpaint=Ne=>{const mt=Ne.changedElements;for(const tt of h)mt.includes(tt.image)&&(tt.needsUpdate=!0)},j.requestPaint();return}const me=0,ae=i.RGBA,$=i.RGBA,Te=i.UNSIGNED_BYTE;i.texElementImage2D(i.TEXTURE_2D,me,ae,$,Te,Y),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE)}}else if(Ie.length>0){if(Be&&Je){const j=ft(Ie[0]);t.texStorage2D(i.TEXTURE_2D,se,re,j.width,j.height)}for(let j=0,me=Ie.length;j<me;j++)ie=Ie[j],Be?D&&t.texSubImage2D(i.TEXTURE_2D,j,0,0,fe,_e,ie):t.texImage2D(i.TEXTURE_2D,j,re,fe,_e,ie);x.generateMipmaps=!1}else if(Be){if(Je){const j=ft(Y);t.texStorage2D(i.TEXTURE_2D,se,re,j.width,j.height)}D&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,fe,_e,Y)}else t.texImage2D(i.TEXTURE_2D,0,re,fe,_e,Y);f(x)&&_(K),ce.__version=ne.version,x.onUpdate&&x.onUpdate(x)}T.__version=x.version}function ve(T,x,k){if(x.image.length!==6)return;const K=X(T,x),Q=x.source;t.bindTexture(i.TEXTURE_CUBE_MAP,T.__webglTexture,i.TEXTURE0+k);const ne=n.get(Q);if(Q.version!==ne.__version||K===!0){t.activeTexture(i.TEXTURE0+k);const ce=We.getPrimaries(We.workingColorSpace),W=x.colorSpace===ni?null:We.getPrimaries(x.colorSpace),Y=x.colorSpace===ni||ce===W?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,x.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),t.pixelStorei(i.UNPACK_ALIGNMENT,x.unpackAlignment),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Y);const fe=x.isCompressedTexture||x.image[0].isCompressedTexture,_e=x.image[0]&&x.image[0].isDataTexture,re=[];for(let $=0;$<6;$++)!fe&&!_e?re[$]=p(x.image[$],!0,s.maxCubemapSize):re[$]=_e?x.image[$].image:x.image[$],re[$]=le(x,re[$]);const ie=re[0],Ie=r.convert(x.format,x.colorSpace),Be=r.convert(x.type),Je=M(x.internalFormat,Ie,Be,x.normalized,x.colorSpace),D=x.isVideoTexture!==!0,se=ne.__version===void 0||K===!0,j=Q.dataReady;let me=E(x,ie);Re(i.TEXTURE_CUBE_MAP,x);let ae;if(fe){D&&se&&t.texStorage2D(i.TEXTURE_CUBE_MAP,me,Je,ie.width,ie.height);for(let $=0;$<6;$++){ae=re[$].mipmaps;for(let Te=0;Te<ae.length;Te++){const Ne=ae[Te];x.format!==rn?Ie!==null?D?j&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,Te,0,0,Ne.width,Ne.height,Ie,Ne.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,Te,Je,Ne.width,Ne.height,0,Ne.data):ye("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):D?j&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,Te,0,0,Ne.width,Ne.height,Ie,Be,Ne.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,Te,Je,Ne.width,Ne.height,0,Ie,Be,Ne.data)}}}else{if(ae=x.mipmaps,D&&se){ae.length>0&&me++;const $=ft(re[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,me,Je,$.width,$.height)}for(let $=0;$<6;$++)if(_e){D?j&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,0,0,re[$].width,re[$].height,Ie,Be,re[$].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,Je,re[$].width,re[$].height,0,Ie,Be,re[$].data);for(let Te=0;Te<ae.length;Te++){const mt=ae[Te].image[$].image;D?j&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,Te+1,0,0,mt.width,mt.height,Ie,Be,mt.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,Te+1,Je,mt.width,mt.height,0,Ie,Be,mt.data)}}else{D?j&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,0,0,Ie,Be,re[$]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,Je,Ie,Be,re[$]);for(let Te=0;Te<ae.length;Te++){const Ne=ae[Te];D?j&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,Te+1,0,0,Ie,Be,Ne.image[$]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,Te+1,Je,Ie,Be,Ne.image[$])}}}f(x)&&_(i.TEXTURE_CUBE_MAP),ne.__version=Q.version,x.onUpdate&&x.onUpdate(x)}T.__version=x.version}function Ee(T,x,k,K,Q,ne){const ce=r.convert(k.format,k.colorSpace),W=r.convert(k.type),Y=M(k.internalFormat,ce,W,k.normalized,k.colorSpace),fe=n.get(x),_e=n.get(k);if(_e.__renderTarget=x,!fe.__hasExternalTextures){const re=Math.max(1,x.width>>ne),ie=Math.max(1,x.height>>ne);Q===i.TEXTURE_3D||Q===i.TEXTURE_2D_ARRAY?t.texImage3D(Q,ne,Y,re,ie,x.depth,0,ce,W,null):t.texImage2D(Q,ne,Y,re,ie,0,ce,W,null)}t.bindFramebuffer(i.FRAMEBUFFER,T),qe(x)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,K,Q,_e.__webglTexture,0,Mt(x)):(Q===i.TEXTURE_2D||Q>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&Q<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,K,Q,_e.__webglTexture,ne),t.bindFramebuffer(i.FRAMEBUFFER,null)}function Ve(T,x,k){if(i.bindRenderbuffer(i.RENDERBUFFER,T),x.depthBuffer){const K=x.depthTexture,Q=K&&K.isDepthTexture?K.type:null,ne=A(x.stencilBuffer,Q),ce=x.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;qe(x)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Mt(x),ne,x.width,x.height):k?i.renderbufferStorageMultisample(i.RENDERBUFFER,Mt(x),ne,x.width,x.height):i.renderbufferStorage(i.RENDERBUFFER,ne,x.width,x.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,ce,i.RENDERBUFFER,T)}else{const K=x.textures;for(let Q=0;Q<K.length;Q++){const ne=K[Q],ce=r.convert(ne.format,ne.colorSpace),W=r.convert(ne.type),Y=M(ne.internalFormat,ce,W,ne.normalized,ne.colorSpace);qe(x)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Mt(x),Y,x.width,x.height):k?i.renderbufferStorageMultisample(i.RENDERBUFFER,Mt(x),Y,x.width,x.height):i.renderbufferStorage(i.RENDERBUFFER,Y,x.width,x.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function ke(T,x,k){const K=x.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,T),!(x.depthTexture&&x.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const Q=n.get(x.depthTexture);if(Q.__renderTarget=x,(!Q.__webglTexture||x.depthTexture.image.width!==x.width||x.depthTexture.image.height!==x.height)&&(x.depthTexture.image.width=x.width,x.depthTexture.image.height=x.height,x.depthTexture.needsUpdate=!0),K){if(Q.__webglInit===void 0&&(Q.__webglInit=!0,x.depthTexture.addEventListener("dispose",w)),Q.__webglTexture===void 0){Q.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,Q.__webglTexture),Re(i.TEXTURE_CUBE_MAP,x.depthTexture);const fe=r.convert(x.depthTexture.format),_e=r.convert(x.depthTexture.type);let re;x.depthTexture.format===Wn?re=i.DEPTH_COMPONENT24:x.depthTexture.format===pi&&(re=i.DEPTH24_STENCIL8);for(let ie=0;ie<6;ie++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ie,0,re,x.width,x.height,0,fe,_e,null)}}else J(x.depthTexture,0);const ne=Q.__webglTexture,ce=Mt(x),W=K?i.TEXTURE_CUBE_MAP_POSITIVE_X+k:i.TEXTURE_2D,Y=x.depthTexture.format===pi?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(x.depthTexture.format===Wn)qe(x)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Y,W,ne,0,ce):i.framebufferTexture2D(i.FRAMEBUFFER,Y,W,ne,0);else if(x.depthTexture.format===pi)qe(x)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Y,W,ne,0,ce):i.framebufferTexture2D(i.FRAMEBUFFER,Y,W,ne,0);else throw new Error("Unknown depthTexture format")}function Ze(T){const x=n.get(T),k=T.isWebGLCubeRenderTarget===!0;if(x.__boundDepthTexture!==T.depthTexture){const K=T.depthTexture;if(x.__depthDisposeCallback&&x.__depthDisposeCallback(),K){const Q=()=>{delete x.__boundDepthTexture,delete x.__depthDisposeCallback,K.removeEventListener("dispose",Q)};K.addEventListener("dispose",Q),x.__depthDisposeCallback=Q}x.__boundDepthTexture=K}if(T.depthTexture&&!x.__autoAllocateDepthBuffer)if(k)for(let K=0;K<6;K++)ke(x.__webglFramebuffer[K],T,K);else{const K=T.texture.mipmaps;K&&K.length>0?ke(x.__webglFramebuffer[0],T,0):ke(x.__webglFramebuffer,T,0)}else if(k){x.__webglDepthbuffer=[];for(let K=0;K<6;K++)if(t.bindFramebuffer(i.FRAMEBUFFER,x.__webglFramebuffer[K]),x.__webglDepthbuffer[K]===void 0)x.__webglDepthbuffer[K]=i.createRenderbuffer(),Ve(x.__webglDepthbuffer[K],T,!1);else{const Q=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ne=x.__webglDepthbuffer[K];i.bindRenderbuffer(i.RENDERBUFFER,ne),i.framebufferRenderbuffer(i.FRAMEBUFFER,Q,i.RENDERBUFFER,ne)}}else{const K=T.texture.mipmaps;if(K&&K.length>0?t.bindFramebuffer(i.FRAMEBUFFER,x.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,x.__webglFramebuffer),x.__webglDepthbuffer===void 0)x.__webglDepthbuffer=i.createRenderbuffer(),Ve(x.__webglDepthbuffer,T,!1);else{const Q=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ne=x.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,ne),i.framebufferRenderbuffer(i.FRAMEBUFFER,Q,i.RENDERBUFFER,ne)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function lt(T,x,k){const K=n.get(T);x!==void 0&&Ee(K.__webglFramebuffer,T,T.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),k!==void 0&&Ze(T)}function Xe(T){const x=T.texture,k=n.get(T),K=n.get(x);T.addEventListener("dispose",b);const Q=T.textures,ne=T.isWebGLCubeRenderTarget===!0,ce=Q.length>1;if(ce||(K.__webglTexture===void 0&&(K.__webglTexture=i.createTexture()),K.__version=x.version,a.memory.textures++),ne){k.__webglFramebuffer=[];for(let W=0;W<6;W++)if(x.mipmaps&&x.mipmaps.length>0){k.__webglFramebuffer[W]=[];for(let Y=0;Y<x.mipmaps.length;Y++)k.__webglFramebuffer[W][Y]=i.createFramebuffer()}else k.__webglFramebuffer[W]=i.createFramebuffer()}else{if(x.mipmaps&&x.mipmaps.length>0){k.__webglFramebuffer=[];for(let W=0;W<x.mipmaps.length;W++)k.__webglFramebuffer[W]=i.createFramebuffer()}else k.__webglFramebuffer=i.createFramebuffer();if(ce)for(let W=0,Y=Q.length;W<Y;W++){const fe=n.get(Q[W]);fe.__webglTexture===void 0&&(fe.__webglTexture=i.createTexture(),a.memory.textures++)}if(T.samples>0&&qe(T)===!1){k.__webglMultisampledFramebuffer=i.createFramebuffer(),k.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,k.__webglMultisampledFramebuffer);for(let W=0;W<Q.length;W++){const Y=Q[W];k.__webglColorRenderbuffer[W]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,k.__webglColorRenderbuffer[W]);const fe=r.convert(Y.format,Y.colorSpace),_e=r.convert(Y.type),re=M(Y.internalFormat,fe,_e,Y.normalized,Y.colorSpace,T.isXRRenderTarget===!0),ie=Mt(T);i.renderbufferStorageMultisample(i.RENDERBUFFER,ie,re,T.width,T.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+W,i.RENDERBUFFER,k.__webglColorRenderbuffer[W])}i.bindRenderbuffer(i.RENDERBUFFER,null),T.depthBuffer&&(k.__webglDepthRenderbuffer=i.createRenderbuffer(),Ve(k.__webglDepthRenderbuffer,T,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(ne){t.bindTexture(i.TEXTURE_CUBE_MAP,K.__webglTexture),Re(i.TEXTURE_CUBE_MAP,x);for(let W=0;W<6;W++)if(x.mipmaps&&x.mipmaps.length>0)for(let Y=0;Y<x.mipmaps.length;Y++)Ee(k.__webglFramebuffer[W][Y],T,x,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+W,Y);else Ee(k.__webglFramebuffer[W],T,x,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+W,0);f(x)&&_(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(ce){for(let W=0,Y=Q.length;W<Y;W++){const fe=Q[W],_e=n.get(fe);let re=i.TEXTURE_2D;(T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(re=T.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(re,_e.__webglTexture),Re(re,fe),Ee(k.__webglFramebuffer,T,fe,i.COLOR_ATTACHMENT0+W,re,0),f(fe)&&_(re)}t.unbindTexture()}else{let W=i.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(W=T.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(W,K.__webglTexture),Re(W,x),x.mipmaps&&x.mipmaps.length>0)for(let Y=0;Y<x.mipmaps.length;Y++)Ee(k.__webglFramebuffer[Y],T,x,i.COLOR_ATTACHMENT0,W,Y);else Ee(k.__webglFramebuffer,T,x,i.COLOR_ATTACHMENT0,W,0);f(x)&&_(W),t.unbindTexture()}T.depthBuffer&&Ze(T)}function vt(T){const x=T.textures;for(let k=0,K=x.length;k<K;k++){const Q=x[k];if(f(Q)){const ne=y(T),ce=n.get(Q).__webglTexture;t.bindTexture(ne,ce),_(ne),t.unbindTexture()}}}const ht=[],jt=[];function F(T){if(T.samples>0){if(qe(T)===!1){const x=T.textures,k=T.width,K=T.height;let Q=i.COLOR_BUFFER_BIT;const ne=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ce=n.get(T),W=x.length>1;if(W)for(let fe=0;fe<x.length;fe++)t.bindFramebuffer(i.FRAMEBUFFER,ce.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+fe,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,ce.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+fe,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,ce.__webglMultisampledFramebuffer);const Y=T.texture.mipmaps;Y&&Y.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ce.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ce.__webglFramebuffer);for(let fe=0;fe<x.length;fe++){if(T.resolveDepthBuffer&&(T.depthBuffer&&(Q|=i.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&(Q|=i.STENCIL_BUFFER_BIT)),W){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,ce.__webglColorRenderbuffer[fe]);const _e=n.get(x[fe]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,_e,0)}i.blitFramebuffer(0,0,k,K,0,0,k,K,Q,i.NEAREST),c===!0&&(ht.length=0,jt.length=0,ht.push(i.COLOR_ATTACHMENT0+fe),T.depthBuffer&&T.resolveDepthBuffer===!1&&(ht.push(ne),jt.push(ne),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,jt)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,ht))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),W)for(let fe=0;fe<x.length;fe++){t.bindFramebuffer(i.FRAMEBUFFER,ce.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+fe,i.RENDERBUFFER,ce.__webglColorRenderbuffer[fe]);const _e=n.get(x[fe]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,ce.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+fe,i.TEXTURE_2D,_e,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ce.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.resolveDepthBuffer===!1&&c){const x=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[x])}}}function Mt(T){return Math.min(s.maxSamples,T.samples)}function qe(T){const x=n.get(T);return T.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&x.__useRenderToTexture!==!1}function ot(T){const x=a.render.frame;d.get(T)!==x&&(d.set(T,x),T.update())}function le(T,x){const k=T.colorSpace,K=T.format,Q=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||k!==Vt&&k!==ni&&(We.getTransfer(k)===$e?(K!==rn||Q!==Jt)&&ye("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Ce("WebGLTextures: Unsupported texture color space:",k)),x}function ft(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(l.width=T.naturalWidth||T.width,l.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(l.width=T.displayWidth,l.height=T.displayHeight):(l.width=T.width,l.height=T.height),l}this.allocateTextureUnit=O,this.resetTextureUnits=V,this.getTextureUnits=q,this.setTextureUnits=C,this.setTexture2D=J,this.setTexture2DArray=Z,this.setTexture3D=te,this.setTextureCube=pe,this.rebindTextures=lt,this.setupRenderTarget=Xe,this.updateRenderTargetMipmap=vt,this.updateMultisampleRenderTarget=F,this.setupDepthRenderbuffer=Ze,this.setupFrameBufferTexture=Ee,this.useMultisampledRTT=qe,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function V_(i,e){function t(n,s=ni){let r;const a=We.getTransfer(s);if(n===Jt)return i.UNSIGNED_BYTE;if(n===Co)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Po)return i.UNSIGNED_SHORT_5_5_5_1;if(n===$l)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Ql)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===Jl)return i.BYTE;if(n===Zl)return i.SHORT;if(n===Es)return i.UNSIGNED_SHORT;if(n===Ro)return i.INT;if(n===An)return i.UNSIGNED_INT;if(n===sn)return i.FLOAT;if(n===Vn)return i.HALF_FLOAT;if(n===eh)return i.ALPHA;if(n===th)return i.RGB;if(n===rn)return i.RGBA;if(n===Wn)return i.DEPTH_COMPONENT;if(n===pi)return i.DEPTH_STENCIL;if(n===Do)return i.RED;if(n===Lo)return i.RED_INTEGER;if(n===vi)return i.RG;if(n===Io)return i.RG_INTEGER;if(n===Fo)return i.RGBA_INTEGER;if(n===hr||n===dr||n===ur||n===fr)if(a===$e)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===hr)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===dr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===ur)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===fr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===hr)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===dr)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===ur)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===fr)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Fa||n===Na||n===Ua||n===Oa)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===Fa)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Na)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Ua)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Oa)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===ka||n===Ba||n===za||n===Ga||n===Ha||n===_r||n===Va)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===ka||n===Ba)return a===$e?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===za)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===Ga)return r.COMPRESSED_R11_EAC;if(n===Ha)return r.COMPRESSED_SIGNED_R11_EAC;if(n===_r)return r.COMPRESSED_RG11_EAC;if(n===Va)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===Wa||n===ja||n===Xa||n===qa||n===Ka||n===Ya||n===Ja||n===Za||n===$a||n===Qa||n===eo||n===to||n===no||n===io)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Wa)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===ja)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Xa)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===qa)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Ka)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Ya)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Ja)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Za)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===$a)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Qa)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===eo)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===to)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===no)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===io)return a===$e?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===so||n===ro||n===ao)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===so)return a===$e?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===ro)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===ao)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===oo||n===co||n===br||n===lo)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===oo)return r.COMPRESSED_RED_RGTC1_EXT;if(n===co)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===br)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===lo)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Ts?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const W_=`
void main() {
