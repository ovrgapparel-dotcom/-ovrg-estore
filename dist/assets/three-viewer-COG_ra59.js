...
}`,k_=[new L(1,0,0),new L(-1,0,0),new L(0,1,0),new L(0,-1,0),new L(0,0,1),new L(0,0,-1)],B_=[new L(0,-1,0),new L(0,-1,0),new L(0,0,1),new L(0,0,-1),new L(0,-1,0),new L(0,-1,0)],Dl=new Ue,ms=new L,ga=new L;function z_(i,e,t){let n=new Ho;const s=new Ce,r=new Ce,a=new rt,o=new yu,c=new Eu,l={},d=t.maxTextureSize,h={[Hn]:Gt,[Gt]:Hn,[xn]:xn},u=new Rn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ce},radius:{value:4}},vertexShader:U_,fragmentShader:O_}),m=u.clone();m.defines.HORIZONTAL_PASS=1;const g=new Wt;g.setAttribute("position",new Lt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new Bt(g,u),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=cr;let f=this.type;this.render=function(E,A,x){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||E.length===0)return;this.type===Gh&&(Se("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=cr);const R=i.getRenderTarget(),I=i.getActiveCubeFace(),C=i.getActiveMipmapLevel(),z=i.state;z.setBlending(zn),z.buffers.depth.getReversed()===!0?z.buffers.color.setClear(0,0,0,0):z.buffers.color.setClear(1,1,1,1),z.buffers.depth.setTest(!0),z.setScissorTest(!1);const W=f!==this.type;W&&A.traverse(function(O){O.material&&(Array.isArray(O.material)?O.material.forEach(P=>P.needsUpdate=!0):O.material.needsUpdate=!0)});for(let O=0,P=E.length;O<P;O++){const B=E[O],U=B.shadow;if(U===void 0){Se("WebGLShadowMap:",B,"has no shadow.");continue}if(U.autoUpdate===!1&&U.needsUpdate===!1)continue;s.copy(U.mapSize);const q=U.getFrameExtents();s.multiply(q),r.copy(U.mapSize),(s.x>d||s.y>d)&&(s.x>d&&(r.x=Math.floor(d/q.x),s.x=r.x*q.x,U.mapSize.x=r.x),s.y>d&&(r.y=Math.floor(d/q.y),s.y=r.y*q.y,U.mapSize.y=r.y));const Q=i.state.buffers.depth.getReversed();if(U.camera._reversedDepth=Q,U.map===null||W===!0){if(U.map!==null&&(U.map.depthTexture!==null&&(U.map.depthTexture.dispose(),U.map.depthTexture=null),U.map.dispose()),this.type===_s){if(B.isPointLight){Se("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}U.map=new En(s.x,s.y,{format:vi,type:Vn,minFilter:Et,magFilter:Et,generateMipmaps:!1}),U.map.texture.name=B.name+".shadowMap",U.map.depthTexture=new Ji(s.x,s.y,sn),U.map.depthTexture.name=B.name+".shadowMapDepth",U.map.depthTexture.format=Wn,U.map.depthTexture.compareFunction=null,U.map.depthTexture.minFilter=yt,U.map.depthTexture.magFilter=yt}else B.isPointLight?(U.map=new Mh(s.x),U.map.depthTexture=new _u(s.x,An)):(U.map=new En(s.x,s.y),U.map.depthTexture=new Ji(s.x,s.y,An)),U.map.depthTexture.name=B.name+".shadowMap",U.map.depthTexture.format=Wn,this.type===cr?(U.map.depthTexture.compareFunction=Q?Uo:Fo,U.map.depthTexture.minFilter=Et,U.map.depthTexture.magFilter=Et):(U.map.depthTexture.compareFunction=null,U.map.depthTexture.minFilter=yt,U.map.depthTexture.magFilter=yt);U.camera.updateProjectionMatrix()}const re=U.map.isWebGLCubeRenderTarget?6:1;for(let ge=0;ge<re;ge++){if(U.map.isWebGLCubeRenderTarget)i.setRenderTarget(U.map,ge),i.clear();else{ge===0&&(i.setRenderTarget(U.map),i.clear());const pe=U.getViewport(ge);a.set(r.x*pe.x,r.y*pe.y,r.x*pe.z,r.y*pe.w),z.viewport(a)}if(B.isPointLight){const pe=U.camera,Oe=U.matrix,qe=B.distance||pe.far;qe!==pe.far&&(pe.far=qe,pe.updateProjectionMatrix()),ms.setFromMatrixPosition(B.matrixWorld),pe.position.copy(ms),ga.copy(pe.position),ga.add(k_[ge]),pe.up.copy(B_[ge]),pe.lookAt(ga),pe.updateMatrixWorld(),Oe.makeTranslation(-ms.x,-ms.y,-ms.z),Dl.multiplyMatrices(pe.projectionMatrix,pe.matrixWorldInverse),U._frustum.setFromProjectionMatrix(Dl,pe.coordinateSystem,pe.reversedDepth)}else U.updateMatrices(B);n=U.getFrustum(),M(A,x,U.camera,B,this.type)}U.isPointLightShadow!==!0&&this.type===_s&&_(U,x),U.needsUpdate=!1}f=this.type,p.needsUpdate=!1,i.setRenderTarget(R,I,C)};function _(E,A){const x=e.update(v);u.defines.VSM_SAMPLES!==E.blurSamples&&(u.defines.VSM_SAMPLES=E.blurSamples,m.defines.VSM_SAMPLES=E.blurSamples,u.needsUpdate=!0,m.needsUpdate=!0),E.mapPass===null&&(E.mapPass=new En(s.x,s.y,{format:vi,type:Vn})),u.uniforms.shadow_pass.value=E.map.depthTexture,u.uniforms.resolution.value=E.mapSize,u.uniforms.radius.value=E.radius,i.setRenderTarget(E.mapPass),i.clear(),i.renderBufferDirect(A,null,x,u,v,null),m.uniforms.shadow_pass.value=E.mapPass.texture,m.uniforms.resolution.value=E.mapSize,m.uniforms.radius.value=E.radius,i.setRenderTarget(E.map),i.clear(),i.renderBufferDirect(A,null,x,m,v,null)}function y(E,A,x,R){let I=null;const C=x.isPointLight===!0?E.customDistanceMaterial:E.customDepthMaterial;if(C!==void 0)I=C;else if(I=x.isPointLight===!0?c:o,i.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0||A.alphaToCoverage===!0){const z=I.uuid,W=A.uuid;let O=l[z];O===void 0&&(O={},l[z]=O);let P=O[W];P===void 0&&(P=I.clone(),O[W]=P,A.addEventListener("dispose",w)),I=P}if(I.visible=A.visible,I.wireframe=A.wireframe,R===_s?I.side=A.shadowSide!==null?A.shadowSide:A.side:I.side=A.shadowSide!==null?A.shadowSide:h[A.side],I.alphaMap=A.alphaMap,I.alphaTest=A.alphaToCoverage===!0?.5:A.alphaTest,I.map=A.map,I.clipShadows=A.clipShadows,I.clippingPlanes=A.clippingPlanes,I.clipIntersection=A.clipIntersection,I.displacementMap=A.displacementMap,I.displacementScale=A.displacementScale,I.displacementBias=A.displacementBias,I.wireframeLinewidth=A.wireframeLinewidth,I.linewidth=A.linewidth,x.isPointLight===!0&&I.isMeshDistanceMaterial===!0){const z=i.properties.get(I);z.light=x}return I}function M(E,A,x,R,I){if(E.visible===!1)return;if(E.layers.test(A.layers)&&(E.isMesh||E.isLine||E.isPoints)&&(E.castShadow||E.receiveShadow&&I===_s)&&(!E.frustumCulled||n.intersectsObject(E))){E.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,E.matrixWorld);const W=e.update(E),O=E.material;if(Array.isArray(O)){const P=W.groups;for(let B=0,U=P.length;B<U;B++){const q=P[B],Q=O[q.materialIndex];if(Q&&Q.visible){const re=y(E,Q,R,I);E.onBeforeShadow(i,E,A,x,W,re,q),i.renderBufferDirect(x,null,W,re,E,q),E.onAfterShadow(i,E,A,x,W,re,q)}}}else if(O.visible){const P=y(E,O,R,I);E.onBeforeShadow(i,E,A,x,W,P,null),i.renderBufferDirect(x,null,W,P,E,null),E.onAfterShadow(i,E,A,x,W,P,null)}}const z=E.children;for(let W=0,O=z.length;W<O;W++)M(z[W],A,x,R,I)}function w(E){E.target.removeEventListener("dispose",w);for(const x in l){const R=l[x],I=E.target.uuid;I in R&&(R[I].dispose(),delete R[I])}}}function G_(i,e){function t(){let D=!1;const se=new rt;let X=null;const me=new rt(0,0,0,0);return{setMask:function(oe){X!==oe&&!D&&(i.colorMask(oe,oe,oe,oe),X=oe)},setLocked:function(oe){D=oe},setClear:function(oe,Z,Ee,Ne,mt){mt===!0&&(oe*=Ne,Z*=Ne,Ee*=Ne),se.set(oe,Z,Ee,Ne),me.equals(se)===!1&&(i.clearColor(oe,Z,Ee,Ne),me.copy(se))},reset:function(){D=!1,X=null,me.set(-1,0,0,0)}}}function n(){let D=!1,se=!1,X=null,me=null,oe=null;return{setReversed:function(Z){if(se!==Z){const Ee=e.get("EXT_clip_control");Z?Ee.clipControlEXT(Ee.LOWER_LEFT_EXT,Ee.ZERO_TO_ONE_EXT):Ee.clipControlEXT(Ee.LOWER_LEFT_EXT,Ee.NEGATIVE_ONE_TO_ONE_EXT),se=Z;const Ne=oe;oe=null,this.setClear(Ne)}},getReversed:function(){return se},setTest:function(Z){Z?ee(i.DEPTH_TEST):ve(i.DEPTH_TEST)},setMask:function(Z){X!==Z&&!D&&(i.depthMask(Z),X=Z)},setFunc:function(Z){if(se&&(Z=yd[Z]),me!==Z){switch(Z){case wa:i.depthFunc(i.NEVER);break;case Ra:i.depthFunc(i.ALWAYS);break;case Ca:i.depthFunc(i.LESS);break;case Xi:i.depthFunc(i.LEQUAL);break;case Pa:i.depthFunc(i.EQUAL);break;case Da:i.depthFunc(i.GEQUAL);break;case La:i.depthFunc(i.GREATER);break;case Ia:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}me=Z}},setLocked:function(Z){D=Z},setClear:function(Z){oe!==Z&&(oe=Z,se&&(Z=1-Z),i.clearDepth(Z))},reset:function(){D=!1,X=null,me=null,oe=null,se=!1}}}function s(){let D=!1,se=null,X=null,me=null,oe=null,Z=null,Ee=null,Ne=null,mt=null;return{setTest:function(et){D||(et?ee(i.STENCIL_TEST):ve(i.STENCIL_TEST))},setMask:function(et){se!==et&&!D&&(i.stencilMask(et),se=et)},setFunc:function(et,Dn,fn){(X!==et||me!==Dn||oe!==fn)&&(i.stencilFunc(et,Dn,fn),X=et,me=Dn,oe=fn)},setOp:function(et,Dn,fn){(Z!==et||Ee!==Dn||Ne!==fn)&&(i.stencilOp(et,Dn,fn),Z=et,Ee=Dn,Ne=fn)},setLocked:function(et){D=et},setClear:function(et){mt!==et&&(i.clearStencil(et),mt=et)},reset:function(){D=!1,se=null,X=null,me=null,oe=null,Z=null,Ee=null,Ne=null,mt=null}}}const r=new t,a=new n,o=new s,c=new WeakMap,l=new WeakMap;let d={},h={},u={},m=new WeakMap,g=[],v=null,p=!1,f=null,_=null,y=null,M=null,w=null,E=null,A=null,x=new De(0,0,0),R=0,I=!1,C=null,z=null,W=null,O=null,P=null;const B=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let U=!1,q=0;const Q=i.getParameter(i.VERSION);Q.indexOf("WebGL")!==-1?(q=parseFloat(/^WebGL (\d)/.exec(Q)[1]),U=q>=1):Q.indexOf("OpenGL ES")!==-1&&(q=parseFloat(/^OpenGL ES (\d)/.exec(Q)[1]),U=q>=2);let re=null,ge={};const pe=i.getParameter(i.SCISSOR_BOX),Oe=i.getParameter(i.VIEWPORT),qe=new rt().fromArray(pe),Pe=new rt().fromArray(Oe);function K(D,se,X,me){const oe=new Uint8Array(4),Z=i.createTexture();i.bindTexture(D,Z),i.texParameteri(D,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(D,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Ee=0;Ee<X;Ee++)D===i.TEXTURE_3D||D===i.TEXTURE_2D_ARRAY?i.texImage3D(se,0,i.RGBA,1,1,me,0,i.RGBA,i.UNSIGNED_BYTE,oe):i.texImage2D(se+Ee,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,oe);return Z}const te={};te[i.TEXTURE_2D]=K(i.TEXTURE_2D,i.TEXTURE_2D,1),te[i.TEXTURE_CUBE_MAP]=K(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),te[i.TEXTURE_2D_ARRAY]=K(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),te[i.TEXTURE_3D]=K(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),ee(i.DEPTH_TEST),a.setFunc(Xi),vt(!1),ht(hc),ee(i.CULL_FACE),lt(zn);function ee(D){d[D]!==!0&&(i.enable(D),d[D]=!0)}function ve(D){d[D]!==!1&&(i.disable(D),d[D]=!1)}function we(D,se){return u[D]!==se?(i.bindFramebuffer(D,se),u[D]=se,D===i.DRAW_FRAMEBUFFER&&(u[i.FRAMEBUFFER]=se),D===i.FRAMEBUFFER&&(u[i.DRAW_FRAMEBUFFER]=se),!0):!1}function ye(D,se){let X=g,me=!1;if(D){X=m.get(se),X===void 0&&(X=[],m.set(se,X));const oe=D.textures;if(X.length!==oe.length||X[0]!==i.COLOR_ATTACHMENT0){for(let Z=0,Ee=oe.length;Z<Ee;Z++)X[Z]=i.COLOR_ATTACHMENT0+Z;X.length=oe.length,me=!0}}else X[0]!==i.BACK&&(X[0]=i.BACK,me=!0);me&&i.drawBuffers(X)}function ct(D){return v!==D?(i.useProgram(D),v=D,!0):!1}const He={[ui]:i.FUNC_ADD,[Vh]:i.FUNC_SUBTRACT,[Wh]:i.FUNC_REVERSE_SUBTRACT};He[jh]=i.MIN,He[Xh]=i.MAX;const Qe={[qh]:i.ZERO,[Kh]:i.ONE,[Yh]:i.SRC_COLOR,[Ta]:i.SRC_ALPHA,[td]:i.SRC_ALPHA_SATURATE,[Qh]:i.DST_COLOR,[Zh]:i.DST_ALPHA,[Jh]:i.ONE_MINUS_SRC_COLOR,[Aa]:i.ONE_MINUS_SRC_ALPHA,[ed]:i.ONE_MINUS_DST_COLOR,[$h]:i.ONE_MINUS_DST_ALPHA,[nd]:i.CONSTANT_COLOR,[id]:i.ONE_MINUS_CONSTANT_COLOR,[sd]:i.CONSTANT_ALPHA,[rd]:i.ONE_MINUS_CONSTANT_ALPHA};function lt(D,se,X,me,oe,Z,Ee,Ne,mt,et){if(D===zn){p===!0&&(ve(i.BLEND),p=!1);return}if(p===!1&&(ee(i.BLEND),p=!0),D!==Hh){if(D!==f||et!==I){if((_!==ui||w!==ui)&&(i.blendEquation(i.FUNC_ADD),_=ui,w=ui),et)switch(D){case Hi:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case dc:i.blendFunc(i.ONE,i.ONE);break;case uc:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case fc:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:Re("WebGLState: Invalid blending: ",D);break}else switch(D){case Hi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case dc:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case uc:Re("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case fc:Re("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Re("WebGLState: Invalid blending: ",D);break}y=null,M=null,E=null,A=null,x.set(0,0,0),R=0,f=D,I=et}return}oe=oe||se,Z=Z||X,Ee=Ee||me,(se!==_||oe!==w)&&(i.blendEquationSeparate(He[se],He[oe]),_=se,w=oe),(X!==y||me!==M||Z!==E||Ee!==A)&&(i.blendFuncSeparate(Qe[X],Qe[me],Qe[Z],Qe[Ee]),y=X,M=me,E=Z,A=Ee),(Ne.equals(x)===!1||mt!==R)&&(i.blendColor(Ne.r,Ne.g,Ne.b,mt),x.copy(Ne),R=mt),f=D,I=!1}function je(D,se){D.side===xn?ve(i.CULL_FACE):ee(i.CULL_FACE);let X=D.side===Gt;se&&(X=!X),vt(X),D.blending===Hi&&D.transparent===!1?lt(zn):lt(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.blendColor,D.blendAlpha,D.premultipliedAlpha),a.setFunc(D.depthFunc),a.setTest(D.depthTest),a.setMask(D.depthWrite),r.setMask(D.colorWrite);const me=D.stencilWrite;o.setTest(me),me&&(o.setMask(D.stencilWriteMask),o.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),o.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),N(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?ee(i.SAMPLE_ALPHA_TO_COVERAGE):ve(i.SAMPLE_ALPHA_TO_COVERAGE)}function vt(D){C!==D&&(D?i.frontFace(i.CW):i.frontFace(i.CCW),C=D)}function ht(D){D!==Bh?(ee(i.CULL_FACE),D!==z&&(D===hc?i.cullFace(i.BACK):D===zh?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):ve(i.CULL_FACE),z=D}function jt(D){D!==W&&(U&&i.lineWidth(D),W=D)}function N(D,se,X){D?(ee(i.POLYGON_OFFSET_FILL),(O!==se||P!==X)&&(O=se,P=X,a.getReversed()&&(se=-se),i.polygonOffset(se,X))):ve(i.POLYGON_OFFSET_FILL)}function Mt(D){D?ee(i.SCISSOR_TEST):ve(i.SCISSOR_TEST)}function Xe(D){D===void 0&&(D=i.TEXTURE0+B-1),re!==D&&(i.activeTexture(D),re=D)}function at(D,se,X){X===void 0&&(re===null?X=i.TEXTURE0+B-1:X=re);let me=ge[X];me===void 0&&(me={type:void 0,texture:void 0},ge[X]=me),(me.type!==D||me.texture!==se)&&(re!==X&&(i.activeTexture(X),re=X),i.bindTexture(D,se||te[D]),me.type=D,me.texture=se)}function le(){const D=ge[re];D!==void 0&&D.type!==void 0&&(i.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function ft(){try{i.compressedTexImage2D(...arguments)}catch(D){Re("WebGLState:",D)}}function T(){try{i.compressedTexImage3D(...arguments)}catch(D){Re("WebGLState:",D)}}function b(){try{i.texSubImage2D(...arguments)}catch(D){Re("WebGLState:",D)}}function k(){try{i.texSubImage3D(...arguments)}catch(D){Re("WebGLState:",D)}}function Y(){try{i.compressedTexSubImage2D(...arguments)}catch(D){Re("WebGLState:",D)}}function $(){try{i.compressedTexSubImage3D(...arguments)}catch(D){Re("WebGLState:",D)}}function ne(){try{i.texStorage2D(...arguments)}catch(D){Re("WebGLState:",D)}}function ce(){try{i.texStorage3D(...arguments)}catch(D){Re("WebGLState:",D)}}function j(){try{i.texImage2D(...arguments)}catch(D){Re("WebGLState:",D)}}function J(){try{i.texImage3D(...arguments)}catch(D){Re("WebGLState:",D)}}function fe(D){return h[D]!==void 0?h[D]:i.getParameter(D)}function be(D,se){h[D]!==se&&(i.pixelStorei(D,se),h[D]=se)}function ae(D){qe.equals(D)===!1&&(i.scissor(D.x,D.y,D.z,D.w),qe.copy(D))}function ie(D){Pe.equals(D)===!1&&(i.viewport(D.x,D.y,D.z,D.w),Pe.copy(D))}function Le(D,se){let X=l.get(se);X===void 0&&(X=new WeakMap,l.set(se,X));let me=X.get(D);me===void 0&&(me=i.getUniformBlockIndex(se,D.name),X.set(D,me))}function ke(D,se){const me=l.get(se).get(D);c.get(se)!==me&&(i.uniformBlockBinding(se,me,D.__bindingPointIndex),c.set(se,me))}function Ye(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),i.pixelStorei(i.PACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,!1),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.BROWSER_DEFAULT_WEBGL),i.pixelStorei(i.PACK_ROW_LENGTH,0),i.pixelStorei(i.PACK_SKIP_PIXELS,0),i.pixelStorei(i.PACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_ROW_LENGTH,0),i.pixelStorei(i.UNPACK_IMAGE_HEIGHT,0),i.pixelStorei(i.UNPACK_SKIP_PIXELS,0),i.pixelStorei(i.UNPACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_SKIP_IMAGES,0),d={},h={},re=null,ge={},u={},m=new WeakMap,g=[],v=null,p=!1,f=null,_=null,y=null,M=null,w=null,E=null,A=null,x=new De(0,0,0),R=0,I=!1,C=null,z=null,W=null,O=null,P=null,qe.set(0,0,i.canvas.width,i.canvas.height),Pe.set(0,0,i.canvas.width,i.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:ee,disable:ve,bindFramebuffer:we,drawBuffers:ye,useProgram:ct,setBlending:lt,setMaterial:je,setFlipSided:vt,setCullFace:ht,setLineWidth:jt,setPolygonOffset:N,setScissorTest:Mt,activeTexture:Xe,bindTexture:at,unbindTexture:le,compressedTexImage2D:ft,compressedTexImage3D:T,texImage2D:j,texImage3D:J,pixelStorei:be,getParameter:fe,updateUBOMapping:Le,uniformBlockBinding:ke,texStorage2D:ne,texStorage3D:ce,texSubImage2D:b,texSubImage3D:k,compressedTexSubImage2D:Y,compressedTexSubImage3D:$,scissor:ae,viewport:ie,reset:Ye}}function H_(i,e,t,n,s,r,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new Ce,d=new WeakMap,h=new Set;let u;const m=new WeakMap;let g=!1;try{g=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function v(T,b){return g?new OffscreenCanvas(T,b):Cs("canvas")}function p(T,b,k){let Y=1;const $=ft(T);if(($.width>k||$.height>k)&&(Y=k/Math.max($.width,$.height)),Y<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){const ne=Math.floor(Y*$.width),ce=Math.floor(Y*$.height);u===void 0&&(u=v(ne,ce));const j=b?v(ne,ce):u;return j.width=ne,j.height=ce,j.getContext("2d").drawImage(T,0,0,ne,ce),Se("WebGLRenderer: Texture has been resized from ("+$.width+"x"+$.height+") to ("+ne+"x"+ce+")."),j}else return"data"in T&&Se("WebGLRenderer: Image in DataTexture is too big ("+$.width+"x"+$.height+")."),T;return T}function f(T){return T.generateMipmaps}function _(T){i.generateMipmap(T)}function y(T){return T.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:T.isWebGL3DRenderTarget?i.TEXTURE_3D:T.isWebGLArrayRenderTarget||T.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function M(T,b,k,Y,$,ne=!1){if(T!==null){if(i[T]!==void 0)return i[T];Se("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let ce;Y&&(ce=e.get("EXT_texture_norm16"),ce||Se("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let j=b;if(b===i.RED&&(k===i.FLOAT&&(j=i.R32F),k===i.HALF_FLOAT&&(j=i.R16F),k===i.UNSIGNED_BYTE&&(j=i.R8),k===i.UNSIGNED_SHORT&&ce&&(j=ce.R16_EXT),k===i.SHORT&&ce&&(j=ce.R16_SNORM_EXT)),b===i.RED_INTEGER&&(k===i.UNSIGNED_BYTE&&(j=i.R8UI),k===i.UNSIGNED_SHORT&&(j=i.R16UI),k===i.UNSIGNED_INT&&(j=i.R32UI),k===i.BYTE&&(j=i.R8I),k===i.SHORT&&(j=i.R16I),k===i.INT&&(j=i.R32I)),b===i.RG&&(k===i.FLOAT&&(j=i.RG32F),k===i.HALF_FLOAT&&(j=i.RG16F),k===i.UNSIGNED_BYTE&&(j=i.RG8),k===i.UNSIGNED_SHORT&&ce&&(j=ce.RG16_EXT),k===i.SHORT&&ce&&(j=ce.RG16_SNORM_EXT)),b===i.RG_INTEGER&&(k===i.UNSIGNED_BYTE&&(j=i.RG8UI),k===i.UNSIGNED_SHORT&&(j=i.RG16UI),k===i.UNSIGNED_INT&&(j=i.RG32UI),k===i.BYTE&&(j=i.RG8I),k===i.SHORT&&(j=i.RG16I),k===i.INT&&(j=i.RG32I)),b===i.RGB_INTEGER&&(k===i.UNSIGNED_BYTE&&(j=i.RGB8UI),k===i.UNSIGNED_SHORT&&(j=i.RGB16UI),k===i.UNSIGNED_INT&&(j=i.RGB32UI),k===i.BYTE&&(j=i.RGB8I),k===i.SHORT&&(j=i.RGB16I),k===i.INT&&(j=i.RGB32I)),b===i.RGBA_INTEGER&&(k===i.UNSIGNED_BYTE&&(j=i.RGBA8UI),k===i.UNSIGNED_SHORT&&(j=i.RGBA16UI),k===i.UNSIGNED_INT&&(j=i.RGBA32UI),k===i.BYTE&&(j=i.RGBA8I),k===i.SHORT&&(j=i.RGBA16I),k===i.INT&&(j=i.RGBA32I)),b===i.RGB&&(k===i.UNSIGNED_SHORT&&ce&&(j=ce.RGB16_EXT),k===i.SHORT&&ce&&(j=ce.RGB16_SNORM_EXT),k===i.UNSIGNED_INT_5_9_9_9_REV&&(j=i.RGB9_E5),k===i.UNSIGNED_INT_10F_11F_11F_REV&&(j=i.R11F_G11F_B10F)),b===i.RGBA){const J=ne?xr:Ve.getTransfer($);k===i.FLOAT&&(j=i.RGBA32F),k===i.HALF_FLOAT&&(j=i.RGBA16F),k===i.UNSIGNED_BYTE&&(j=J===Je?i.SRGB8_ALPHA8:i.RGBA8),k===i.UNSIGNED_SHORT&&ce&&(j=ce.RGBA16_EXT),k===i.SHORT&&ce&&(j=ce.RGBA16_SNORM_EXT),k===i.UNSIGNED_SHORT_4_4_4_4&&(j=i.RGBA4),k===i.UNSIGNED_SHORT_5_5_5_1&&(j=i.RGB5_A1)}return(j===i.R16F||j===i.R32F||j===i.RG16F||j===i.RG32F||j===i.RGBA16F||j===i.RGBA32F)&&e.get("EXT_color_buffer_float"),j}function w(T,b){let k;return T?b===null||b===An||b===Ts?k=i.DEPTH24_STENCIL8:b===sn?k=i.DEPTH32F_STENCIL8:b===Es&&(k=i.DEPTH24_STENCIL8,Se("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):b===null||b===An||b===Ts?k=i.DEPTH_COMPONENT24:b===sn?k=i.DEPTH_COMPONENT32F:b===Es&&(k=i.DEPTH_COMPONENT16),k}function E(T,b){return f(T)===!0||T.isFramebufferTexture&&T.minFilter!==yt&&T.minFilter!==Et?Math.log2(Math.max(b.width,b.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?b.mipmaps.length:1}function A(T){const b=T.target;b.removeEventListener("dispose",A),R(b),b.isVideoTexture&&d.delete(b),b.isHTMLTexture&&h.delete(b)}function x(T){const b=T.target;b.removeEventListener("dispose",x),C(b)}function R(T){const b=n.get(T);if(b.__webglInit===void 0)return;const k=T.source,Y=m.get(k);if(Y){const $=Y[b.__cacheKey];$.usedTimes--,$.usedTimes===0&&I(T),Object.keys(Y).length===0&&m.delete(k)}n.remove(T)}function I(T){const b=n.get(T);i.deleteTexture(b.__webglTexture);const k=T.source,Y=m.get(k);delete Y[b.__cacheKey],a.memory.textures--}function C(T){const b=n.get(T);if(T.depthTexture&&(T.depthTexture.dispose(),n.remove(T.depthTexture)),T.isWebGLCubeRenderTarget)for(let Y=0;Y<6;Y++){if(Array.isArray(b.__webglFramebuffer[Y]))for(let $=0;$<b.__webglFramebuffer[Y].length;$++)i.deleteFramebuffer(b.__webglFramebuffer[Y][$]);else i.deleteFramebuffer(b.__webglFramebuffer[Y]);b.__webglDepthbuffer&&i.deleteRenderbuffer(b.__webglDepthbuffer[Y])}else{if(Array.isArray(b.__webglFramebuffer))for(let Y=0;Y<b.__webglFramebuffer.length;Y++)i.deleteFramebuffer(b.__webglFramebuffer[Y]);else i.deleteFramebuffer(b.__webglFramebuffer);if(b.__webglDepthbuffer&&i.deleteRenderbuffer(b.__webglDepthbuffer),b.__webglMultisampledFramebuffer&&i.deleteFramebuffer(b.__webglMultisampledFramebuffer),b.__webglColorRenderbuffer)for(let Y=0;Y<b.__webglColorRenderbuffer.length;Y++)b.__webglColorRenderbuffer[Y]&&i.deleteRenderbuffer(b.__webglColorRenderbuffer[Y]);b.__webglDepthRenderbuffer&&i.deleteRenderbuffer(b.__webglDepthRenderbuffer)}const k=T.textures;for(let Y=0,$=k.length;Y<$;Y++){const ne=n.get(k[Y]);ne.__webglTexture&&(i.deleteTexture(ne.__webglTexture),a.memory.textures--),n.remove(k[Y])}n.remove(T)}let z=0;function W(){z=0}function O(){return z}function P(T){z=T}function B(){const T=z;return T>=s.maxTextures&&Se("WebGLTextures: Trying to use "+T+" texture units while this GPU supports only "+s.maxTextures),z+=1,T}function U(T){const b=[];return b.push(T.wrapS),b.push(T.wrapT),b.push(T.wrapR||0),b.push(T.magFilter),b.push(T.minFilter),b.push(T.anisotropy),b.push(T.internalFormat),b.push(T.format),b.push(T.type),b.push(T.generateMipmaps),b.push(T.premultiplyAlpha),b.push(T.flipY),b.push(T.unpackAlignment),b.push(T.colorSpace),b.join()}function q(T,b){const k=n.get(T);if(T.isVideoTexture&&at(T),T.isRenderTargetTexture===!1&&T.isExternalTexture!==!0&&T.version>0&&k.__version!==T.version){const Y=T.image;if(Y===null)Se("WebGLRenderer: Texture marked for update but no image data found.");else if(Y.complete===!1)Se("WebGLRenderer: Texture marked for update but image is incomplete");else{ve(k,T,b);return}}else T.isExternalTexture&&(k.__webglTexture=T.sourceTexture?T.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,k.__webglTexture,i.TEXTURE0+b)}function Q(T,b){const k=n.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&k.__version!==T.version){ve(k,T,b);return}else T.isExternalTexture&&(k.__webglTexture=T.sourceTexture?T.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,k.__webglTexture,i.TEXTURE0+b)}function re(T,b){const k=n.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&k.__version!==T.version){ve(k,T,b);return}t.bindTexture(i.TEXTURE_3D,k.__webglTexture,i.TEXTURE0+b)}function ge(T,b){const k=n.get(T);if(T.isCubeDepthTexture!==!0&&T.version>0&&k.__version!==T.version){we(k,T,b);return}t.bindTexture(i.TEXTURE_CUBE_MAP,k.__webglTexture,i.TEXTURE0+b)}const pe={[Ki]:i.REPEAT,[vn]:i.CLAMP_TO_EDGE,[gr]:i.MIRRORED_REPEAT},Oe={[yt]:i.NEAREST,[Yl]:i.NEAREST_MIPMAP_NEAREST,[bs]:i.NEAREST_MIPMAP_LINEAR,[Et]:i.LINEAR,[lr]:i.LINEAR_MIPMAP_NEAREST,[kn]:i.LINEAR_MIPMAP_LINEAR},qe={[fd]:i.NEVER,[bd]:i.ALWAYS,[pd]:i.LESS,[Fo]:i.LEQUAL,[md]:i.EQUAL,[Uo]:i.GEQUAL,[gd]:i.GREATER,[_d]:i.NOTEQUAL};function Pe(T,b){if(b.type===sn&&e.has("OES_texture_float_linear")===!1&&(b.magFilter===Et||b.magFilter===lr||b.magFilter===bs||b.magFilter===kn||b.minFilter===Et||b.minFilter===lr||b.minFilter===bs||b.minFilter===kn)&&Se("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(T,i.TEXTURE_WRAP_S,pe[b.wrapS]),i.texParameteri(T,i.TEXTURE_WRAP_T,pe[b.wrapT]),(T===i.TEXTURE_3D||T===i.TEXTURE_2D_ARRAY)&&i.texParameteri(T,i.TEXTURE_WRAP_R,pe[b.wrapR]),i.texParameteri(T,i.TEXTURE_MAG_FILTER,Oe[b.magFilter]),i.texParameteri(T,i.TEXTURE_MIN_FILTER,Oe[b.minFilter]),b.compareFunction&&(i.texParameteri(T,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(T,i.TEXTURE_COMPARE_FUNC,qe[b.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(b.magFilter===yt||b.minFilter!==bs&&b.minFilter!==kn||b.type===sn&&e.has("OES_texture_float_linear")===!1)return;if(b.anisotropy>1||n.get(b).__currentAnisotropy){const k=e.get("EXT_texture_filter_anisotropic");i.texParameterf(T,k.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(b.anisotropy,s.getMaxAnisotropy())),n.get(b).__currentAnisotropy=b.anisotropy}}}function K(T,b){let k=!1;T.__webglInit===void 0&&(T.__webglInit=!0,b.addEventListener("dispose",A));const Y=b.source;let $=m.get(Y);$===void 0&&($={},m.set(Y,$));const ne=U(b);if(ne!==T.__cacheKey){$[ne]===void 0&&($[ne]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,k=!0),$[ne].usedTimes++;const ce=$[T.__cacheKey];ce!==void 0&&($[T.__cacheKey].usedTimes--,ce.usedTimes===0&&I(b)),T.__cacheKey=ne,T.__webglTexture=$[ne].texture}return k}function te(T,b,k){return Math.floor(Math.floor(T/k)/b)}function ee(T,b,k,Y){const ne=T.updateRanges;if(ne.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,b.width,b.height,k,Y,b.data);else{ne.sort((be,ae)=>be.start-ae.start);let ce=0;for(let be=1;be<ne.length;be++){const ae=ne[ce],ie=ne[be],Le=ae.start+ae.count,ke=te(ie.start,b.width,4),Ye=te(ae.start,b.width,4);ie.start<=Le+1&&ke===Ye&&te(ie.start+ie.count-1,b.width,4)===ke?ae.count=Math.max(ae.count,ie.start+ie.count-ae.start):(++ce,ne[ce]=ie)}ne.length=ce+1;const j=t.getParameter(i.UNPACK_ROW_LENGTH),J=t.getParameter(i.UNPACK_SKIP_PIXELS),fe=t.getParameter(i.UNPACK_SKIP_ROWS);t.pixelStorei(i.UNPACK_ROW_LENGTH,b.width);for(let be=0,ae=ne.length;be<ae;be++){const ie=ne[be],Le=Math.floor(ie.start/4),ke=Math.ceil(ie.count/4),Ye=Le%b.width,D=Math.floor(Le/b.width),se=ke,X=1;t.pixelStorei(i.UNPACK_SKIP_PIXELS,Ye),t.pixelStorei(i.UNPACK_SKIP_ROWS,D),t.texSubImage2D(i.TEXTURE_2D,0,Ye,D,se,X,k,Y,b.data)}T.clearUpdateRanges(),t.pixelStorei(i.UNPACK_ROW_LENGTH,j),t.pixelStorei(i.UNPACK_SKIP_PIXELS,J),t.pixelStorei(i.UNPACK_SKIP_ROWS,fe)}}function ve(T,b,k){let Y=i.TEXTURE_2D;(b.isDataArrayTexture||b.isCompressedArrayTexture)&&(Y=i.TEXTURE_2D_ARRAY),b.isData3DTexture&&(Y=i.TEXTURE_3D);const $=K(T,b),ne=b.source;t.bindTexture(Y,T.__webglTexture,i.TEXTURE0+k);const ce=n.get(ne);if(ne.version!==ce.__version||$===!0){if(t.activeTexture(i.TEXTURE0+k),(typeof ImageBitmap<"u"&&b.image instanceof ImageBitmap)===!1){const X=Ve.getPrimaries(Ve.workingColorSpace),me=b.colorSpace===ni?null:Ve.getPrimaries(b.colorSpace),oe=b.colorSpace===ni||X===me?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,b.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,oe)}t.pixelStorei(i.UNPACK_ALIGNMENT,b.unpackAlignment);let J=p(b.image,!1,s.maxTextureSize);J=le(b,J);const fe=r.convert(b.format,b.colorSpace),be=r.convert(b.type);let ae=M(b.internalFormat,fe,be,b.normalized,b.colorSpace,b.isVideoTexture);Pe(Y,b);let ie;const Le=b.mipmaps,ke=b.isVideoTexture!==!0,Ye=ce.__version===void 0||$===!0,D=ne.dataReady,se=E(b,J);if(b.isDepthTexture)ae=w(b.format===pi,b.type),Ye&&(ke?t.texStorage2D(i.TEXTURE_2D,1,ae,J.width,J.height):t.texImage2D(i.TEXTURE_2D,0,ae,J.width,J.height,0,fe,be,null));else if(b.isDataTexture)if(Le.length>0){ke&&Ye&&t.texStorage2D(i.TEXTURE_2D,se,ae,Le[0].width,Le[0].height);for(let X=0,me=Le.length;X<me;X++)ie=Le[X],ke?D&&t.texSubImage2D(i.TEXTURE_2D,X,0,0,ie.width,ie.height,fe,be,ie.data):t.texImage2D(i.TEXTURE_2D,X,ae,ie.width,ie.height,0,fe,be,ie.data);b.generateMipmaps=!1}else ke?(Ye&&t.texStorage2D(i.TEXTURE_2D,se,ae,J.width,J.height),D&&ee(b,J,fe,be)):t.texImage2D(i.TEXTURE_2D,0,ae,J.width,J.height,0,fe,be,J.data);else if(b.isCompressedTexture)if(b.isCompressedArrayTexture){ke&&Ye&&t.texStorage3D(i.TEXTURE_2D_ARRAY,se,ae,Le[0].width,Le[0].height,J.depth);for(let X=0,me=Le.length;X<me;X++)if(ie=Le[X],b.format!==rn)if(fe!==null)if(ke){if(D)if(b.layerUpdates.size>0){const oe=cl(ie.width,ie.height,b.format,b.type);for(const Z of b.layerUpdates){const Ee=ie.data.subarray(Z*oe/ie.data.BYTES_PER_ELEMENT,(Z+1)*oe/ie.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,X,0,0,Z,ie.width,ie.height,1,fe,Ee)}b.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,X,0,0,0,ie.width,ie.height,J.depth,fe,ie.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,X,ae,ie.width,ie.height,J.depth,0,ie.data,0,0);else Se("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else ke?D&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,X,0,0,0,ie.width,ie.height,J.depth,fe,be,ie.data):t.texImage3D(i.TEXTURE_2D_ARRAY,X,ae,ie.width,ie.height,J.depth,0,fe,be,ie.data)}else{ke&&Ye&&t.texStorage2D(i.TEXTURE_2D,se,ae,Le[0].width,Le[0].height);for(let X=0,me=Le.length;X<me;X++)ie=Le[X],b.format!==rn?fe!==null?ke?D&&t.compressedTexSubImage2D(i.TEXTURE_2D,X,0,0,ie.width,ie.height,fe,ie.data):t.compressedTexImage2D(i.TEXTURE_2D,X,ae,ie.width,ie.height,0,ie.data):Se("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):ke?D&&t.texSubImage2D(i.TEXTURE_2D,X,0,0,ie.width,ie.height,fe,be,ie.data):t.texImage2D(i.TEXTURE_2D,X,ae,ie.width,ie.height,0,fe,be,ie.data)}else if(b.isDataArrayTexture)if(ke){if(Ye&&t.texStorage3D(i.TEXTURE_2D_ARRAY,se,ae,J.width,J.height,J.depth),D)if(b.layerUpdates.size>0){const X=cl(J.width,J.height,b.format,b.type);for(const me of b.layerUpdates){const oe=J.data.subarray(me*X/J.data.BYTES_PER_ELEMENT,(me+1)*X/J.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,me,J.width,J.height,1,fe,be,oe)}b.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,J.width,J.height,J.depth,fe,be,J.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,ae,J.width,J.height,J.depth,0,fe,be,J.data);else if(b.isData3DTexture)ke?(Ye&&t.texStorage3D(i.TEXTURE_3D,se,ae,J.width,J.height,J.depth),D&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,J.width,J.height,J.depth,fe,be,J.data)):t.texImage3D(i.TEXTURE_3D,0,ae,J.width,J.height,J.depth,0,fe,be,J.data);else if(b.isFramebufferTexture){if(Ye)if(ke)t.texStorage2D(i.TEXTURE_2D,se,ae,J.width,J.height);else{let X=J.width,me=J.height;for(let oe=0;oe<se;oe++)t.texImage2D(i.TEXTURE_2D,oe,ae,X,me,0,fe,be,null),X>>=1,me>>=1}}else if(b.isHTMLTexture){if("texElementImage2D"in i){const X=i.canvas;if(X.hasAttribute("layoutsubtree")||X.setAttribute("layoutsubtree","true"),J.parentNode!==X){X.appendChild(J),h.add(b),X.onpaint=Ne=>{const mt=Ne.changedElements;for(const et of h)mt.includes(et.image)&&(et.needsUpdate=!0)},X.requestPaint();return}const me=0,oe=i.RGBA,Z=i.RGBA,Ee=i.UNSIGNED_BYTE;i.texElementImage2D(i.TEXTURE_2D,me,oe,Z,Ee,J),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE)}}else if(Le.length>0){if(ke&&Ye){const X=ft(Le[0]);t.texStorage2D(i.TEXTURE_2D,se,ae,X.width,X.height)}for(let X=0,me=Le.length;X<me;X++)ie=Le[X],ke?D&&t.texSubImage2D(i.TEXTURE_2D,X,0,0,fe,be,ie):t.texImage2D(i.TEXTURE_2D,X,ae,fe,be,ie);b.generateMipmaps=!1}else if(ke){if(Ye){const X=ft(J);t.texStorage2D(i.TEXTURE_2D,se,ae,X.width,X.height)}D&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,fe,be,J)}else t.texImage2D(i.TEXTURE_2D,0,ae,fe,be,J);f(b)&&_(Y),ce.__version=ne.version,b.onUpdate&&b.onUpdate(b)}T.__version=b.version}function we(T,b,k){if(b.image.length!==6)return;const Y=K(T,b),$=b.source;t.bindTexture(i.TEXTURE_CUBE_MAP,T.__webglTexture,i.TEXTURE0+k);const ne=n.get($);if($.version!==ne.__version||Y===!0){t.activeTexture(i.TEXTURE0+k);const ce=Ve.getPrimaries(Ve.workingColorSpace),j=b.colorSpace===ni?null:Ve.getPrimaries(b.colorSpace),J=b.colorSpace===ni||ce===j?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,b.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),t.pixelStorei(i.UNPACK_ALIGNMENT,b.unpackAlignment),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,J);const fe=b.isCompressedTexture||b.image[0].isCompressedTexture,be=b.image[0]&&b.image[0].isDataTexture,ae=[];for(let Z=0;Z<6;Z++)!fe&&!be?ae[Z]=p(b.image[Z],!0,s.maxCubemapSize):ae[Z]=be?b.image[Z].image:b.image[Z],ae[Z]=le(b,ae[Z]);const ie=ae[0],Le=r.convert(b.format,b.colorSpace),ke=r.convert(b.type),Ye=M(b.internalFormat,Le,ke,b.normalized,b.colorSpace),D=b.isVideoTexture!==!0,se=ne.__version===void 0||Y===!0,X=$.dataReady;let me=E(b,ie);Pe(i.TEXTURE_CUBE_MAP,b);let oe;if(fe){D&&se&&t.texStorage2D(i.TEXTURE_CUBE_MAP,me,Ye,ie.width,ie.height);for(let Z=0;Z<6;Z++){oe=ae[Z].mipmaps;for(let Ee=0;Ee<oe.length;Ee++){const Ne=oe[Ee];b.format!==rn?Le!==null?D?X&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,Ee,0,0,Ne.width,Ne.height,Le,Ne.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,Ee,Ye,Ne.width,Ne.height,0,Ne.data):Se("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):D?X&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,Ee,0,0,Ne.width,Ne.height,Le,ke,Ne.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,Ee,Ye,Ne.width,Ne.height,0,Le,ke,Ne.data)}}}else{if(oe=b.mipmaps,D&&se){oe.length>0&&me++;const Z=ft(ae[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,me,Ye,Z.width,Z.height)}for(let Z=0;Z<6;Z++)if(be){D?X&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,0,0,ae[Z].width,ae[Z].height,Le,ke,ae[Z].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,Ye,ae[Z].width,ae[Z].height,0,Le,ke,ae[Z].data);for(let Ee=0;Ee<oe.length;Ee++){const mt=oe[Ee].image[Z].image;D?X&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,Ee+1,0,0,mt.width,mt.height,Le,ke,mt.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,Ee+1,Ye,mt.width,mt.height,0,Le,ke,mt.data)}}else{D?X&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,0,0,Le,ke,ae[Z]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,Ye,Le,ke,ae[Z]);for(let Ee=0;Ee<oe.length;Ee++){const Ne=oe[Ee];D?X&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,Ee+1,0,0,Le,ke,Ne.image[Z]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,Ee+1,Ye,Le,ke,Ne.image[Z])}}}f(b)&&_(i.TEXTURE_CUBE_MAP),ne.__version=$.version,b.onUpdate&&b.onUpdate(b)}T.__version=b.version}function ye(T,b,k,Y,$,ne){const ce=r.convert(k.format,k.colorSpace),j=r.convert(k.type),J=M(k.internalFormat,ce,j,k.normalized,k.colorSpace),fe=n.get(b),be=n.get(k);if(be.__renderTarget=b,!fe.__hasExternalTextures){const ae=Math.max(1,b.width>>ne),ie=Math.max(1,b.height>>ne);$===i.TEXTURE_3D||$===i.TEXTURE_2D_ARRAY?t.texImage3D($,ne,J,ae,ie,b.depth,0,ce,j,null):t.texImage2D($,ne,J,ae,ie,0,ce,j,null)}t.bindFramebuffer(i.FRAMEBUFFER,T),Xe(b)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Y,$,be.__webglTexture,0,Mt(b)):($===i.TEXTURE_2D||$>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&$<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,Y,$,be.__webglTexture,ne),t.bindFramebuffer(i.FRAMEBUFFER,null)}function ct(T,b,k){if(i.bindRenderbuffer(i.RENDERBUFFER,T),b.depthBuffer){const Y=b.depthTexture,$=Y&&Y.isDepthTexture?Y.type:null,ne=w(b.stencilBuffer,$),ce=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;Xe(b)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Mt(b),ne,b.width,b.height):k?i.renderbufferStorageMultisample(i.RENDERBUFFER,Mt(b),ne,b.width,b.height):i.renderbufferStorage(i.RENDERBUFFER,ne,b.width,b.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,ce,i.RENDERBUFFER,T)}else{const Y=b.textures;for(let $=0;$<Y.length;$++){const ne=Y[$],ce=r.convert(ne.format,ne.colorSpace),j=r.convert(ne.type),J=M(ne.internalFormat,ce,j,ne.normalized,ne.colorSpace);Xe(b)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Mt(b),J,b.width,b.height):k?i.renderbufferStorageMultisample(i.RENDERBUFFER,Mt(b),J,b.width,b.height):i.renderbufferStorage(i.RENDERBUFFER,J,b.width,b.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function He(T,b,k){const Y=b.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,T),!(b.depthTexture&&b.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const $=n.get(b.depthTexture);if($.__renderTarget=b,(!$.__webglTexture||b.depthTexture.image.width!==b.width||b.depthTexture.image.height!==b.height)&&(b.depthTexture.image.width=b.width,b.depthTexture.image.height=b.height,b.depthTexture.needsUpdate=!0),Y){if($.__webglInit===void 0&&($.__webglInit=!0,b.depthTexture.addEventListener("dispose",A)),$.__webglTexture===void 0){$.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,$.__webglTexture),Pe(i.TEXTURE_CUBE_MAP,b.depthTexture);const fe=r.convert(b.depthTexture.format),be=r.convert(b.depthTexture.type);let ae;b.depthTexture.format===Wn?ae=i.DEPTH_COMPONENT24:b.depthTexture.format===pi&&(ae=i.DEPTH24_STENCIL8);for(let ie=0;ie<6;ie++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ie,0,ae,b.width,b.height,0,fe,be,null)}}else q(b.depthTexture,0);const ne=$.__webglTexture,ce=Mt(b),j=Y?i.TEXTURE_CUBE_MAP_POSITIVE_X+k:i.TEXTURE_2D,J=b.depthTexture.format===pi?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(b.depthTexture.format===Wn)Xe(b)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,J,j,ne,0,ce):i.framebufferTexture2D(i.FRAMEBUFFER,J,j,ne,0);else if(b.depthTexture.format===pi)Xe(b)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,J,j,ne,0,ce):i.framebufferTexture2D(i.FRAMEBUFFER,J,j,ne,0);else throw new Error("Unknown depthTexture format")}function Qe(T){const b=n.get(T),k=T.isWebGLCubeRenderTarget===!0;if(b.__boundDepthTexture!==T.depthTexture){const Y=T.depthTexture;if(b.__depthDisposeCallback&&b.__depthDisposeCallback(),Y){const $=()=>{delete b.__boundDepthTexture,delete b.__depthDisposeCallback,Y.removeEventListener("dispose",$)};Y.addEventListener("dispose",$),b.__depthDisposeCallback=$}b.__boundDepthTexture=Y}if(T.depthTexture&&!b.__autoAllocateDepthBuffer)if(k)for(let Y=0;Y<6;Y++)He(b.__webglFramebuffer[Y],T,Y);else{const Y=T.texture.mipmaps;Y&&Y.length>0?He(b.__webglFramebuffer[0],T,0):He(b.__webglFramebuffer,T,0)}else if(k){b.__webglDepthbuffer=[];for(let Y=0;Y<6;Y++)if(t.bindFramebuffer(i.FRAMEBUFFER,b.__webglFramebuffer[Y]),b.__webglDepthbuffer[Y]===void 0)b.__webglDepthbuffer[Y]=i.createRenderbuffer(),ct(b.__webglDepthbuffer[Y],T,!1);else{const $=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ne=b.__webglDepthbuffer[Y];i.bindRenderbuffer(i.RENDERBUFFER,ne),i.framebufferRenderbuffer(i.FRAMEBUFFER,$,i.RENDERBUFFER,ne)}}else{const Y=T.texture.mipmaps;if(Y&&Y.length>0?t.bindFramebuffer(i.FRAMEBUFFER,b.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,b.__webglFramebuffer),b.__webglDepthbuffer===void 0)b.__webglDepthbuffer=i.createRenderbuffer(),ct(b.__webglDepthbuffer,T,!1);else{const $=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ne=b.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,ne),i.framebufferRenderbuffer(i.FRAMEBUFFER,$,i.RENDERBUFFER,ne)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function lt(T,b,k){const Y=n.get(T);b!==void 0&&ye(Y.__webglFramebuffer,T,T.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),k!==void 0&&Qe(T)}function je(T){const b=T.texture,k=n.get(T),Y=n.get(b);T.addEventListener("dispose",x);const $=T.textures,ne=T.isWebGLCubeRenderTarget===!0,ce=$.length>1;if(ce||(Y.__webglTexture===void 0&&(Y.__webglTexture=i.createTexture()),Y.__version=b.version,a.memory.textures++),ne){k.__webglFramebuffer=[];for(let j=0;j<6;j++)if(b.mipmaps&&b.mipmaps.length>0){k.__webglFramebuffer[j]=[];for(let J=0;J<b.mipmaps.length;J++)k.__webglFramebuffer[j][J]=i.createFramebuffer()}else k.__webglFramebuffer[j]=i.createFramebuffer()}else{if(b.mipmaps&&b.mipmaps.length>0){k.__webglFramebuffer=[];for(let j=0;j<b.mipmaps.length;j++)k.__webglFramebuffer[j]=i.createFramebuffer()}else k.__webglFramebuffer=i.createFramebuffer();if(ce)for(let j=0,J=$.length;j<J;j++){const fe=n.get($[j]);fe.__webglTexture===void 0&&(fe.__webglTexture=i.createTexture(),a.memory.textures++)}if(T.samples>0&&Xe(T)===!1){k.__webglMultisampledFramebuffer=i.createFramebuffer(),k.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,k.__webglMultisampledFramebuffer);for(let j=0;j<$.length;j++){const J=$[j];k.__webglColorRenderbuffer[j]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,k.__webglColorRenderbuffer[j]);const fe=r.convert(J.format,J.colorSpace),be=r.convert(J.type),ae=M(J.internalFormat,fe,be,J.normalized,J.colorSpace,T.isXRRenderTarget===!0),ie=Mt(T);i.renderbufferStorageMultisample(i.RENDERBUFFER,ie,ae,T.width,T.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+j,i.RENDERBUFFER,k.__webglColorRenderbuffer[j])}i.bindRenderbuffer(i.RENDERBUFFER,null),T.depthBuffer&&(k.__webglDepthRenderbuffer=i.createRenderbuffer(),ct(k.__webglDepthRenderbuffer,T,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(ne){t.bindTexture(i.TEXTURE_CUBE_MAP,Y.__webglTexture),Pe(i.TEXTURE_CUBE_MAP,b);for(let j=0;j<6;j++)if(b.mipmaps&&b.mipmaps.length>0)for(let J=0;J<b.mipmaps.length;J++)ye(k.__webglFramebuffer[j][J],T,b,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+j,J);else ye(k.__webglFramebuffer[j],T,b,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0);f(b)&&_(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(ce){for(let j=0,J=$.length;j<J;j++){const fe=$[j],be=n.get(fe);let ae=i.TEXTURE_2D;(T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(ae=T.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(ae,be.__webglTexture),Pe(ae,fe),ye(k.__webglFramebuffer,T,fe,i.COLOR_ATTACHMENT0+j,ae,0),f(fe)&&_(ae)}t.unbindTexture()}else{let j=i.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(j=T.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(j,Y.__webglTexture),Pe(j,b),b.mipmaps&&b.mipmaps.length>0)for(let J=0;J<b.mipmaps.length;J++)ye(k.__webglFramebuffer[J],T,b,i.COLOR_ATTACHMENT0,j,J);else ye(k.__webglFramebuffer,T,b,i.COLOR_ATTACHMENT0,j,0);f(b)&&_(j),t.unbindTexture()}T.depthBuffer&&Qe(T)}function vt(T){const b=T.textures;for(let k=0,Y=b.length;k<Y;k++){const $=b[k];if(f($)){const ne=y(T),ce=n.get($).__webglTexture;t.bindTexture(ne,ce),_(ne),t.unbindTexture()}}}const ht=[],jt=[];function N(T){if(T.samples>0){if(Xe(T)===!1){const b=T.textures,k=T.width,Y=T.height;let $=i.COLOR_BUFFER_BIT;const ne=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ce=n.get(T),j=b.length>1;if(j)for(let fe=0;fe<b.length;fe++)t.bindFramebuffer(i.FRAMEBUFFER,ce.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+fe,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,ce.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+fe,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,ce.__webglMultisampledFramebuffer);const J=T.texture.mipmaps;J&&J.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ce.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ce.__webglFramebuffer);for(let fe=0;fe<b.length;fe++){if(T.resolveDepthBuffer&&(T.depthBuffer&&($|=i.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&($|=i.STENCIL_BUFFER_BIT)),j){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,ce.__webglColorRenderbuffer[fe]);const be=n.get(b[fe]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,be,0)}i.blitFramebuffer(0,0,k,Y,0,0,k,Y,$,i.NEAREST),c===!0&&(ht.length=0,jt.length=0,ht.push(i.COLOR_ATTACHMENT0+fe),T.depthBuffer&&T.resolveDepthBuffer===!1&&(ht.push(ne),jt.push(ne),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,jt)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,ht))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),j)for(let fe=0;fe<b.length;fe++){t.bindFramebuffer(i.FRAMEBUFFER,ce.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+fe,i.RENDERBUFFER,ce.__webglColorRenderbuffer[fe]);const be=n.get(b[fe]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,ce.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+fe,i.TEXTURE_2D,be,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ce.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.resolveDepthBuffer===!1&&c){const b=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[b])}}}function Mt(T){return Math.min(s.maxSamples,T.samples)}function Xe(T){const b=n.get(T);return T.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&b.__useRenderToTexture!==!1}function at(T){const b=a.render.frame;d.get(T)!==b&&(d.set(T,b),T.update())}function le(T,b){const k=T.colorSpace,Y=T.format,$=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||k!==Vt&&k!==ni&&(Ve.getTransfer(k)===Je?(Y!==rn||$!==Jt)&&Se("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Re("WebGLTextures: Unsupported texture color space:",k)),b}function ft(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(l.width=T.naturalWidth||T.width,l.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(l.width=T.displayWidth,l.height=T.displayHeight):(l.width=T.width,l.height=T.height),l}this.allocateTextureUnit=B,this.resetTextureUnits=W,this.getTextureUnits=O,this.setTextureUnits=P,this.setTexture2D=q,this.setTexture2DArray=Q,this.setTexture3D=re,this.setTextureCube=ge,this.rebindTextures=lt,this.setupRenderTarget=je,this.updateRenderTargetMipmap=vt,this.updateMultisampleRenderTarget=N,this.setupDepthRenderbuffer=Qe,this.setupFrameBufferTexture=ye,this.useMultisampledRTT=Xe,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function V_(i,e){function t(n,s=ni){let r;const a=Ve.getTransfer(s);if(n===Jt)return i.UNSIGNED_BYTE;if(n===Co)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Po)return i.UNSIGNED_SHORT_5_5_5_1;if(n===$l)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Ql)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===Jl)return i.BYTE;if(n===Zl)return i.SHORT;if(n===Es)return i.UNSIGNED_SHORT;if(n===Ro)return i.INT;if(n===An)return i.UNSIGNED_INT;if(n===sn)return i.FLOAT;if(n===Vn)return i.HALF_FLOAT;if(n===eh)return i.ALPHA;if(n===th)return i.RGB;if(n===rn)return i.RGBA;if(n===Wn)return i.DEPTH_COMPONENT;if(n===pi)return i.DEPTH_STENCIL;if(n===Do)return i.RED;if(n===Lo)return i.RED_INTEGER;if(n===vi)return i.RG;if(n===Io)return i.RG_INTEGER;if(n===No)return i.RGBA_INTEGER;if(n===hr||n===dr||n===ur||n===fr)if(a===Je)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===hr)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===dr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===ur)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===fr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===hr)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===dr)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===ur)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===fr)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Na||n===Fa||n===Ua||n===Oa)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===Na)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Fa)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Ua)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Oa)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===ka||n===Ba||n===za||n===Ga||n===Ha||n===_r||n===Va)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===ka||n===Ba)return a===Je?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===za)return a===Je?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===Ga)return r.COMPRESSED_R11_EAC;if(n===Ha)return r.COMPRESSED_SIGNED_R11_EAC;if(n===_r)return r.COMPRESSED_RG11_EAC;if(n===Va)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===Wa||n===ja||n===Xa||n===qa||n===Ka||n===Ya||n===Ja||n===Za||n===$a||n===Qa||n===eo||n===to||n===no||n===io)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Wa)return a===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===ja)return a===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Xa)return a===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===qa)return a===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Ka)return a===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Ya)return a===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Ja)return a===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Za)return a===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===$a)return a===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Qa)return a===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===eo)return a===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===to)return a===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===no)return a===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===io)return a===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===so||n===ro||n===ao)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===so)return a===Je?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===ro)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===ao)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===oo||n===co||n===br||n===lo)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===oo)return r.COMPRESSED_RED_RGTC1_EXT;if(n===co)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===br)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===lo)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Ts?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const W_=`
void main() {
