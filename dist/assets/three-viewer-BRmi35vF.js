...
`)+`
`+f);const y=_+p+a,M=_+f+o,w=Ml(s,s.VERTEX_SHADER,y),E=Ml(s,s.FRAGMENT_SHADER,M);s.attachShader(v,w),s.attachShader(v,E),t.index0AttributeName!==void 0?s.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(v,0,"position"),s.linkProgram(v);function A(C){if(i.debug.checkShaderErrors){const z=s.getProgramInfoLog(v)||"",W=s.getShaderInfoLog(w)||"",O=s.getShaderInfoLog(E)||"",P=z.trim(),B=W.trim(),U=O.trim();let K=!0,Q=!0;if(s.getProgramParameter(v,s.LINK_STATUS)===!1)if(K=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,v,w,E);else{const ee=yl(s,w,"vertex"),pe=yl(s,E,"fragment");Ce("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(v,s.VALIDATE_STATUS)+`
...
}`,k_=[new L(1,0,0),new L(-1,0,0),new L(0,1,0),new L(0,-1,0),new L(0,0,1),new L(0,0,-1)],B_=[new L(0,-1,0),new L(0,-1,0),new L(0,0,1),new L(0,0,-1),new L(0,-1,0),new L(0,-1,0)],Dl=new Ue,ms=new L,ga=new L;function z_(i,e,t){let n=new Ho;const s=new Pe,r=new Pe,a=new rt,o=new yu,c=new Eu,l={},d=t.maxTextureSize,h={[Hn]:Gt,[Gt]:Hn,[xn]:xn},u=new Rn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Pe},radius:{value:4}},vertexShader:U_,fragmentShader:O_}),m=u.clone();m.defines.HORIZONTAL_PASS=1;const g=new Wt;g.setAttribute("position",new Lt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new Bt(g,u),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=or;let f=this.type;this.render=function(E,A,x){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||E.length===0)return;this.type===Gh&&(Se("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=or);const R=i.getRenderTarget(),I=i.getActiveCubeFace(),C=i.getActiveMipmapLevel(),z=i.state;z.setBlending(zn),z.buffers.depth.getReversed()===!0?z.buffers.color.setClear(0,0,0,0):z.buffers.color.setClear(1,1,1,1),z.buffers.depth.setTest(!0),z.setScissorTest(!1);const W=f!==this.type;W&&A.traverse(function(O){O.material&&(Array.isArray(O.material)?O.material.forEach(P=>P.needsUpdate=!0):O.material.needsUpdate=!0)});for(let O=0,P=E.length;O<P;O++){const B=E[O],U=B.shadow;if(U===void 0){Se("WebGLShadowMap:",B,"has no shadow.");continue}if(U.autoUpdate===!1&&U.needsUpdate===!1)continue;s.copy(U.mapSize);const K=U.getFrameExtents();s.multiply(K),r.copy(U.mapSize),(s.x>d||s.y>d)&&(s.x>d&&(r.x=Math.floor(d/K.x),s.x=r.x*K.x,U.mapSize.x=r.x),s.y>d&&(r.y=Math.floor(d/K.y),s.y=r.y*K.y,U.mapSize.y=r.y));const Q=i.state.buffers.depth.getReversed();if(U.camera._reversedDepth=Q,U.map===null||W===!0){if(U.map!==null&&(U.map.depthTexture!==null&&(U.map.depthTexture.dispose(),U.map.depthTexture=null),U.map.dispose()),this.type===_s){if(B.isPointLight){Se("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}U.map=new En(s.x,s.y,{format:vi,type:Vn,minFilter:Et,magFilter:Et,generateMipmaps:!1}),U.map.texture.name=B.name+".shadowMap",U.map.depthTexture=new Ji(s.x,s.y,sn),U.map.depthTexture.name=B.name+".shadowMapDepth",U.map.depthTexture.format=Wn,U.map.depthTexture.compareFunction=null,U.map.depthTexture.minFilter=yt,U.map.depthTexture.magFilter=yt}else B.isPointLight?(U.map=new Mh(s.x),U.map.depthTexture=new _u(s.x,An)):(U.map=new En(s.x,s.y),U.map.depthTexture=new Ji(s.x,s.y,An)),U.map.depthTexture.name=B.name+".shadowMap",U.map.depthTexture.format=Wn,this.type===or?(U.map.depthTexture.compareFunction=Q?Uo:No,U.map.depthTexture.minFilter=Et,U.map.depthTexture.magFilter=Et):(U.map.depthTexture.compareFunction=null,U.map.depthTexture.minFilter=yt,U.map.depthTexture.magFilter=yt);U.camera.updateProjectionMatrix()}const ee=U.map.isWebGLCubeRenderTarget?6:1;for(let pe=0;pe<ee;pe++){if(U.map.isWebGLCubeRenderTarget)i.setRenderTarget(U.map,pe),i.clear();else{pe===0&&(i.setRenderTarget(U.map),i.clear());const xe=U.getViewport(pe);a.set(r.x*xe.x,r.y*xe.y,r.x*xe.z,r.y*xe.w),z.viewport(a)}if(B.isPointLight){const xe=U.camera,We=U.matrix,qe=B.distance||xe.far;qe!==xe.far&&(xe.far=qe,xe.updateProjectionMatrix()),ms.setFromMatrixPosition(B.matrixWorld),xe.position.copy(ms),ga.copy(xe.position),ga.add(k_[pe]),xe.up.copy(B_[pe]),xe.lookAt(ga),xe.updateMatrixWorld(),We.makeTranslation(-ms.x,-ms.y,-ms.z),Dl.multiplyMatrices(xe.projectionMatrix,xe.matrixWorldInverse),U._frustum.setFromProjectionMatrix(Dl,xe.coordinateSystem,xe.reversedDepth)}else U.updateMatrices(B);n=U.getFrustum(),M(A,x,U.camera,B,this.type)}U.isPointLightShadow!==!0&&this.type===_s&&_(U,x),U.needsUpdate=!1}f=this.type,p.needsUpdate=!1,i.setRenderTarget(R,I,C)};function _(E,A){const x=e.update(v);u.defines.VSM_SAMPLES!==E.blurSamples&&(u.defines.VSM_SAMPLES=E.blurSamples,m.defines.VSM_SAMPLES=E.blurSamples,u.needsUpdate=!0,m.needsUpdate=!0),E.mapPass===null&&(E.mapPass=new En(s.x,s.y,{format:vi,type:Vn})),u.uniforms.shadow_pass.value=E.map.depthTexture,u.uniforms.resolution.value=E.mapSize,u.uniforms.radius.value=E.radius,i.setRenderTarget(E.mapPass),i.clear(),i.renderBufferDirect(A,null,x,u,v,null),m.uniforms.shadow_pass.value=E.mapPass.texture,m.uniforms.resolution.value=E.mapSize,m.uniforms.radius.value=E.radius,i.setRenderTarget(E.map),i.clear(),i.renderBufferDirect(A,null,x,m,v,null)}function y(E,A,x,R){let I=null;const C=x.isPointLight===!0?E.customDistanceMaterial:E.customDepthMaterial;if(C!==void 0)I=C;else if(I=x.isPointLight===!0?c:o,i.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0||A.alphaToCoverage===!0){const z=I.uuid,W=A.uuid;let O=l[z];O===void 0&&(O={},l[z]=O);let P=O[W];P===void 0&&(P=I.clone(),O[W]=P,A.addEventListener("dispose",w)),I=P}if(I.visible=A.visible,I.wireframe=A.wireframe,R===_s?I.side=A.shadowSide!==null?A.shadowSide:A.side:I.side=A.shadowSide!==null?A.shadowSide:h[A.side],I.alphaMap=A.alphaMap,I.alphaTest=A.alphaToCoverage===!0?.5:A.alphaTest,I.map=A.map,I.clipShadows=A.clipShadows,I.clippingPlanes=A.clippingPlanes,I.clipIntersection=A.clipIntersection,I.displacementMap=A.displacementMap,I.displacementScale=A.displacementScale,I.displacementBias=A.displacementBias,I.wireframeLinewidth=A.wireframeLinewidth,I.linewidth=A.linewidth,x.isPointLight===!0&&I.isMeshDistanceMaterial===!0){const z=i.properties.get(I);z.light=x}return I}function M(E,A,x,R,I){if(E.visible===!1)return;if(E.layers.test(A.layers)&&(E.isMesh||E.isLine||E.isPoints)&&(E.castShadow||E.receiveShadow&&I===_s)&&(!E.frustumCulled||n.intersectsObject(E))){E.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,E.matrixWorld);const W=e.update(E),O=E.material;if(Array.isArray(O)){const P=W.groups;for(let B=0,U=P.length;B<U;B++){const K=P[B],Q=O[K.materialIndex];if(Q&&Q.visible){const ee=y(E,Q,R,I);E.onBeforeShadow(i,E,A,x,W,ee,K),i.renderBufferDirect(x,null,W,ee,E,K),E.onAfterShadow(i,E,A,x,W,ee,K)}}}else if(O.visible){const P=y(E,O,R,I);E.onBeforeShadow(i,E,A,x,W,P,null),i.renderBufferDirect(x,null,W,P,E,null),E.onAfterShadow(i,E,A,x,W,P,null)}}const z=E.children;for(let W=0,O=z.length;W<O;W++)M(z[W],A,x,R,I)}function w(E){E.target.removeEventListener("dispose",w);for(const x in l){const R=l[x],I=E.target.uuid;I in R&&(R[I].dispose(),delete R[I])}}}function G_(i,e){function t(){let D=!1;const se=new rt;let q=null;const me=new rt(0,0,0,0);return{setMask:function(ae){q!==ae&&!D&&(i.colorMask(ae,ae,ae,ae),q=ae)},setLocked:function(ae){D=ae},setClear:function(ae,Z,Ee,Fe,mt){mt===!0&&(ae*=Fe,Z*=Fe,Ee*=Fe),se.set(ae,Z,Ee,Fe),me.equals(se)===!1&&(i.clearColor(ae,Z,Ee,Fe),me.copy(se))},reset:function(){D=!1,q=null,me.set(-1,0,0,0)}}}function n(){let D=!1,se=!1,q=null,me=null,ae=null;return{setReversed:function(Z){if(se!==Z){const Ee=e.get("EXT_clip_control");Z?Ee.clipControlEXT(Ee.LOWER_LEFT_EXT,Ee.ZERO_TO_ONE_EXT):Ee.clipControlEXT(Ee.LOWER_LEFT_EXT,Ee.NEGATIVE_ONE_TO_ONE_EXT),se=Z;const Fe=ae;ae=null,this.setClear(Fe)}},getReversed:function(){return se},setTest:function(Z){Z?te(i.DEPTH_TEST):ve(i.DEPTH_TEST)},setMask:function(Z){q!==Z&&!D&&(i.depthMask(Z),q=Z)},setFunc:function(Z){if(se&&(Z=yd[Z]),me!==Z){switch(Z){case wa:i.depthFunc(i.NEVER);break;case Ra:i.depthFunc(i.ALWAYS);break;case Ca:i.depthFunc(i.LESS);break;case Xi:i.depthFunc(i.LEQUAL);break;case Pa:i.depthFunc(i.EQUAL);break;case Da:i.depthFunc(i.GEQUAL);break;case La:i.depthFunc(i.GREATER);break;case Ia:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}me=Z}},setLocked:function(Z){D=Z},setClear:function(Z){ae!==Z&&(ae=Z,se&&(Z=1-Z),i.clearDepth(Z))},reset:function(){D=!1,q=null,me=null,ae=null,se=!1}}}function s(){let D=!1,se=null,q=null,me=null,ae=null,Z=null,Ee=null,Fe=null,mt=null;return{setTest:function(et){D||(et?te(i.STENCIL_TEST):ve(i.STENCIL_TEST))},setMask:function(et){se!==et&&!D&&(i.stencilMask(et),se=et)},setFunc:function(et,Dn,fn){(q!==et||me!==Dn||ae!==fn)&&(i.stencilFunc(et,Dn,fn),q=et,me=Dn,ae=fn)},setOp:function(et,Dn,fn){(Z!==et||Ee!==Dn||Fe!==fn)&&(i.stencilOp(et,Dn,fn),Z=et,Ee=Dn,Fe=fn)},setLocked:function(et){D=et},setClear:function(et){mt!==et&&(i.clearStencil(et),mt=et)},reset:function(){D=!1,se=null,q=null,me=null,ae=null,Z=null,Ee=null,Fe=null,mt=null}}}const r=new t,a=new n,o=new s,c=new WeakMap,l=new WeakMap;let d={},h={},u={},m=new WeakMap,g=[],v=null,p=!1,f=null,_=null,y=null,M=null,w=null,E=null,A=null,x=new De(0,0,0),R=0,I=!1,C=null,z=null,W=null,O=null,P=null;const B=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let U=!1,K=0;const Q=i.getParameter(i.VERSION);Q.indexOf("WebGL")!==-1?(K=parseFloat(/^WebGL (\d)/.exec(Q)[1]),U=K>=1):Q.indexOf("OpenGL ES")!==-1&&(K=parseFloat(/^OpenGL ES (\d)/.exec(Q)[1]),U=K>=2);let ee=null,pe={};const xe=i.getParameter(i.SCISSOR_BOX),We=i.getParameter(i.VIEWPORT),qe=new rt().fromArray(xe),we=new rt().fromArray(We);function X(D,se,q,me){const ae=new Uint8Array(4),Z=i.createTexture();i.bindTexture(D,Z),i.texParameteri(D,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(D,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Ee=0;Ee<q;Ee++)D===i.TEXTURE_3D||D===i.TEXTURE_2D_ARRAY?i.texImage3D(se,0,i.RGBA,1,1,me,0,i.RGBA,i.UNSIGNED_BYTE,ae):i.texImage2D(se+Ee,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,ae);return Z}const ce={};ce[i.TEXTURE_2D]=X(i.TEXTURE_2D,i.TEXTURE_2D,1),ce[i.TEXTURE_CUBE_MAP]=X(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),ce[i.TEXTURE_2D_ARRAY]=X(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),ce[i.TEXTURE_3D]=X(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),te(i.DEPTH_TEST),a.setFunc(Xi),vt(!1),ht(hc),te(i.CULL_FACE),lt(zn);function te(D){d[D]!==!0&&(i.enable(D),d[D]=!0)}function ve(D){d[D]!==!1&&(i.disable(D),d[D]=!1)}function Re(D,se){return u[D]!==se?(i.bindFramebuffer(D,se),u[D]=se,D===i.DRAW_FRAMEBUFFER&&(u[i.FRAMEBUFFER]=se),D===i.FRAMEBUFFER&&(u[i.DRAW_FRAMEBUFFER]=se),!0):!1}function ye(D,se){let q=g,me=!1;if(D){q=m.get(se),q===void 0&&(q=[],m.set(se,q));const ae=D.textures;if(q.length!==ae.length||q[0]!==i.COLOR_ATTACHMENT0){for(let Z=0,Ee=ae.length;Z<Ee;Z++)q[Z]=i.COLOR_ATTACHMENT0+Z;q.length=ae.length,me=!0}}else q[0]!==i.BACK&&(q[0]=i.BACK,me=!0);me&&i.drawBuffers(q)}function ct(D){return v!==D?(i.useProgram(D),v=D,!0):!1}const Ge={[ui]:i.FUNC_ADD,[Vh]:i.FUNC_SUBTRACT,[Wh]:i.FUNC_REVERSE_SUBTRACT};Ge[jh]=i.MIN,Ge[Xh]=i.MAX;const Qe={[qh]:i.ZERO,[Kh]:i.ONE,[Yh]:i.SRC_COLOR,[Ta]:i.SRC_ALPHA,[td]:i.SRC_ALPHA_SATURATE,[Qh]:i.DST_COLOR,[Zh]:i.DST_ALPHA,[Jh]:i.ONE_MINUS_SRC_COLOR,[Aa]:i.ONE_MINUS_SRC_ALPHA,[ed]:i.ONE_MINUS_DST_COLOR,[$h]:i.ONE_MINUS_DST_ALPHA,[nd]:i.CONSTANT_COLOR,[id]:i.ONE_MINUS_CONSTANT_COLOR,[sd]:i.CONSTANT_ALPHA,[rd]:i.ONE_MINUS_CONSTANT_ALPHA};function lt(D,se,q,me,ae,Z,Ee,Fe,mt,et){if(D===zn){p===!0&&(ve(i.BLEND),p=!1);return}if(p===!1&&(te(i.BLEND),p=!0),D!==Hh){if(D!==f||et!==I){if((_!==ui||w!==ui)&&(i.blendEquation(i.FUNC_ADD),_=ui,w=ui),et)switch(D){case Hi:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case dc:i.blendFunc(i.ONE,i.ONE);break;case uc:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case fc:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:Ce("WebGLState: Invalid blending: ",D);break}else switch(D){case Hi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case dc:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case uc:Ce("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case fc:Ce("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Ce("WebGLState: Invalid blending: ",D);break}y=null,M=null,E=null,A=null,x.set(0,0,0),R=0,f=D,I=et}return}ae=ae||se,Z=Z||q,Ee=Ee||me,(se!==_||ae!==w)&&(i.blendEquationSeparate(Ge[se],Ge[ae]),_=se,w=ae),(q!==y||me!==M||Z!==E||Ee!==A)&&(i.blendFuncSeparate(Qe[q],Qe[me],Qe[Z],Qe[Ee]),y=q,M=me,E=Z,A=Ee),(Fe.equals(x)===!1||mt!==R)&&(i.blendColor(Fe.r,Fe.g,Fe.b,mt),x.copy(Fe),R=mt),f=D,I=!1}function je(D,se){D.side===xn?ve(i.CULL_FACE):te(i.CULL_FACE);let q=D.side===Gt;se&&(q=!q),vt(q),D.blending===Hi&&D.transparent===!1?lt(zn):lt(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.blendColor,D.blendAlpha,D.premultipliedAlpha),a.setFunc(D.depthFunc),a.setTest(D.depthTest),a.setMask(D.depthWrite),r.setMask(D.colorWrite);const me=D.stencilWrite;o.setTest(me),me&&(o.setMask(D.stencilWriteMask),o.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),o.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),F(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?te(i.SAMPLE_ALPHA_TO_COVERAGE):ve(i.SAMPLE_ALPHA_TO_COVERAGE)}function vt(D){C!==D&&(D?i.frontFace(i.CW):i.frontFace(i.CCW),C=D)}function ht(D){D!==Bh?(te(i.CULL_FACE),D!==z&&(D===hc?i.cullFace(i.BACK):D===zh?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):ve(i.CULL_FACE),z=D}function jt(D){D!==W&&(U&&i.lineWidth(D),W=D)}function F(D,se,q){D?(te(i.POLYGON_OFFSET_FILL),(O!==se||P!==q)&&(O=se,P=q,a.getReversed()&&(se=-se),i.polygonOffset(se,q))):ve(i.POLYGON_OFFSET_FILL)}function Mt(D){D?te(i.SCISSOR_TEST):ve(i.SCISSOR_TEST)}function Xe(D){D===void 0&&(D=i.TEXTURE0+B-1),ee!==D&&(i.activeTexture(D),ee=D)}function at(D,se,q){q===void 0&&(ee===null?q=i.TEXTURE0+B-1:q=ee);let me=pe[q];me===void 0&&(me={type:void 0,texture:void 0},pe[q]=me),(me.type!==D||me.texture!==se)&&(ee!==q&&(i.activeTexture(q),ee=q),i.bindTexture(D,se||ce[D]),me.type=D,me.texture=se)}function le(){const D=pe[ee];D!==void 0&&D.type!==void 0&&(i.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function ft(){try{i.compressedTexImage2D(...arguments)}catch(D){Ce("WebGLState:",D)}}function T(){try{i.compressedTexImage3D(...arguments)}catch(D){Ce("WebGLState:",D)}}function b(){try{i.texSubImage2D(...arguments)}catch(D){Ce("WebGLState:",D)}}function k(){try{i.texSubImage3D(...arguments)}catch(D){Ce("WebGLState:",D)}}function Y(){try{i.compressedTexSubImage2D(...arguments)}catch(D){Ce("WebGLState:",D)}}function $(){try{i.compressedTexSubImage3D(...arguments)}catch(D){Ce("WebGLState:",D)}}function ne(){try{i.texStorage2D(...arguments)}catch(D){Ce("WebGLState:",D)}}function oe(){try{i.texStorage3D(...arguments)}catch(D){Ce("WebGLState:",D)}}function j(){try{i.texImage2D(...arguments)}catch(D){Ce("WebGLState:",D)}}function J(){try{i.texImage3D(...arguments)}catch(D){Ce("WebGLState:",D)}}function fe(D){return h[D]!==void 0?h[D]:i.getParameter(D)}function _e(D,se){h[D]!==se&&(i.pixelStorei(D,se),h[D]=se)}function re(D){qe.equals(D)===!1&&(i.scissor(D.x,D.y,D.z,D.w),qe.copy(D))}function ie(D){we.equals(D)===!1&&(i.viewport(D.x,D.y,D.z,D.w),we.copy(D))}function Le(D,se){let q=l.get(se);q===void 0&&(q=new WeakMap,l.set(se,q));let me=q.get(D);me===void 0&&(me=i.getUniformBlockIndex(se,D.name),q.set(D,me))}function Oe(D,se){const me=l.get(se).get(D);c.get(se)!==me&&(i.uniformBlockBinding(se,me,D.__bindingPointIndex),c.set(se,me))}function Ye(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),i.pixelStorei(i.PACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,!1),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.BROWSER_DEFAULT_WEBGL),i.pixelStorei(i.PACK_ROW_LENGTH,0),i.pixelStorei(i.PACK_SKIP_PIXELS,0),i.pixelStorei(i.PACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_ROW_LENGTH,0),i.pixelStorei(i.UNPACK_IMAGE_HEIGHT,0),i.pixelStorei(i.UNPACK_SKIP_PIXELS,0),i.pixelStorei(i.UNPACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_SKIP_IMAGES,0),d={},h={},ee=null,pe={},u={},m=new WeakMap,g=[],v=null,p=!1,f=null,_=null,y=null,M=null,w=null,E=null,A=null,x=new De(0,0,0),R=0,I=!1,C=null,z=null,W=null,O=null,P=null,qe.set(0,0,i.canvas.width,i.canvas.height),we.set(0,0,i.canvas.width,i.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:te,disable:ve,bindFramebuffer:Re,drawBuffers:ye,useProgram:ct,setBlending:lt,setMaterial:je,setFlipSided:vt,setCullFace:ht,setLineWidth:jt,setPolygonOffset:F,setScissorTest:Mt,activeTexture:Xe,bindTexture:at,unbindTexture:le,compressedTexImage2D:ft,compressedTexImage3D:T,texImage2D:j,texImage3D:J,pixelStorei:_e,getParameter:fe,updateUBOMapping:Le,uniformBlockBinding:Oe,texStorage2D:ne,texStorage3D:oe,texSubImage2D:b,texSubImage3D:k,compressedTexSubImage2D:Y,compressedTexSubImage3D:$,scissor:re,viewport:ie,reset:Ye}}function H_(i,e,t,n,s,r,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new Pe,d=new WeakMap,h=new Set;let u;const m=new WeakMap;let g=!1;try{g=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function v(T,b){return g?new OffscreenCanvas(T,b):Rs("canvas")}function p(T,b,k){let Y=1;const $=ft(T);if(($.width>k||$.height>k)&&(Y=k/Math.max($.width,$.height)),Y<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){const ne=Math.floor(Y*$.width),oe=Math.floor(Y*$.height);u===void 0&&(u=v(ne,oe));const j=b?v(ne,oe):u;return j.width=ne,j.height=oe,j.getContext("2d").drawImage(T,0,0,ne,oe),Se("WebGLRenderer: Texture has been resized from ("+$.width+"x"+$.height+") to ("+ne+"x"+oe+")."),j}else return"data"in T&&Se("WebGLRenderer: Image in DataTexture is too big ("+$.width+"x"+$.height+")."),T;return T}function f(T){return T.generateMipmaps}function _(T){i.generateMipmap(T)}function y(T){return T.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:T.isWebGL3DRenderTarget?i.TEXTURE_3D:T.isWebGLArrayRenderTarget||T.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function M(T,b,k,Y,$,ne=!1){if(T!==null){if(i[T]!==void 0)return i[T];Se("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let oe;Y&&(oe=e.get("EXT_texture_norm16"),oe||Se("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let j=b;if(b===i.RED&&(k===i.FLOAT&&(j=i.R32F),k===i.HALF_FLOAT&&(j=i.R16F),k===i.UNSIGNED_BYTE&&(j=i.R8),k===i.UNSIGNED_SHORT&&oe&&(j=oe.R16_EXT),k===i.SHORT&&oe&&(j=oe.R16_SNORM_EXT)),b===i.RED_INTEGER&&(k===i.UNSIGNED_BYTE&&(j=i.R8UI),k===i.UNSIGNED_SHORT&&(j=i.R16UI),k===i.UNSIGNED_INT&&(j=i.R32UI),k===i.BYTE&&(j=i.R8I),k===i.SHORT&&(j=i.R16I),k===i.INT&&(j=i.R32I)),b===i.RG&&(k===i.FLOAT&&(j=i.RG32F),k===i.HALF_FLOAT&&(j=i.RG16F),k===i.UNSIGNED_BYTE&&(j=i.RG8),k===i.UNSIGNED_SHORT&&oe&&(j=oe.RG16_EXT),k===i.SHORT&&oe&&(j=oe.RG16_SNORM_EXT)),b===i.RG_INTEGER&&(k===i.UNSIGNED_BYTE&&(j=i.RG8UI),k===i.UNSIGNED_SHORT&&(j=i.RG16UI),k===i.UNSIGNED_INT&&(j=i.RG32UI),k===i.BYTE&&(j=i.RG8I),k===i.SHORT&&(j=i.RG16I),k===i.INT&&(j=i.RG32I)),b===i.RGB_INTEGER&&(k===i.UNSIGNED_BYTE&&(j=i.RGB8UI),k===i.UNSIGNED_SHORT&&(j=i.RGB16UI),k===i.UNSIGNED_INT&&(j=i.RGB32UI),k===i.BYTE&&(j=i.RGB8I),k===i.SHORT&&(j=i.RGB16I),k===i.INT&&(j=i.RGB32I)),b===i.RGBA_INTEGER&&(k===i.UNSIGNED_BYTE&&(j=i.RGBA8UI),k===i.UNSIGNED_SHORT&&(j=i.RGBA16UI),k===i.UNSIGNED_INT&&(j=i.RGBA32UI),k===i.BYTE&&(j=i.RGBA8I),k===i.SHORT&&(j=i.RGBA16I),k===i.INT&&(j=i.RGBA32I)),b===i.RGB&&(k===i.UNSIGNED_SHORT&&oe&&(j=oe.RGB16_EXT),k===i.SHORT&&oe&&(j=oe.RGB16_SNORM_EXT),k===i.UNSIGNED_INT_5_9_9_9_REV&&(j=i.RGB9_E5),k===i.UNSIGNED_INT_10F_11F_11F_REV&&(j=i.R11F_G11F_B10F)),b===i.RGBA){const J=ne?br:He.getTransfer($);k===i.FLOAT&&(j=i.RGBA32F),k===i.HALF_FLOAT&&(j=i.RGBA16F),k===i.UNSIGNED_BYTE&&(j=J===Je?i.SRGB8_ALPHA8:i.RGBA8),k===i.UNSIGNED_SHORT&&oe&&(j=oe.RGBA16_EXT),k===i.SHORT&&oe&&(j=oe.RGBA16_SNORM_EXT),k===i.UNSIGNED_SHORT_4_4_4_4&&(j=i.RGBA4),k===i.UNSIGNED_SHORT_5_5_5_1&&(j=i.RGB5_A1)}return(j===i.R16F||j===i.R32F||j===i.RG16F||j===i.RG32F||j===i.RGBA16F||j===i.RGBA32F)&&e.get("EXT_color_buffer_float"),j}function w(T,b){let k;return T?b===null||b===An||b===Es?k=i.DEPTH24_STENCIL8:b===sn?k=i.DEPTH32F_STENCIL8:b===ys&&(k=i.DEPTH24_STENCIL8,Se("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):b===null||b===An||b===Es?k=i.DEPTH_COMPONENT24:b===sn?k=i.DEPTH_COMPONENT32F:b===ys&&(k=i.DEPTH_COMPONENT16),k}function E(T,b){return f(T)===!0||T.isFramebufferTexture&&T.minFilter!==yt&&T.minFilter!==Et?Math.log2(Math.max(b.width,b.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?b.mipmaps.length:1}function A(T){const b=T.target;b.removeEventListener("dispose",A),R(b),b.isVideoTexture&&d.delete(b),b.isHTMLTexture&&h.delete(b)}function x(T){const b=T.target;b.removeEventListener("dispose",x),C(b)}function R(T){const b=n.get(T);if(b.__webglInit===void 0)return;const k=T.source,Y=m.get(k);if(Y){const $=Y[b.__cacheKey];$.usedTimes--,$.usedTimes===0&&I(T),Object.keys(Y).length===0&&m.delete(k)}n.remove(T)}function I(T){const b=n.get(T);i.deleteTexture(b.__webglTexture);const k=T.source,Y=m.get(k);delete Y[b.__cacheKey],a.memory.textures--}function C(T){const b=n.get(T);if(T.depthTexture&&(T.depthTexture.dispose(),n.remove(T.depthTexture)),T.isWebGLCubeRenderTarget)for(let Y=0;Y<6;Y++){if(Array.isArray(b.__webglFramebuffer[Y]))for(let $=0;$<b.__webglFramebuffer[Y].length;$++)i.deleteFramebuffer(b.__webglFramebuffer[Y][$]);else i.deleteFramebuffer(b.__webglFramebuffer[Y]);b.__webglDepthbuffer&&i.deleteRenderbuffer(b.__webglDepthbuffer[Y])}else{if(Array.isArray(b.__webglFramebuffer))for(let Y=0;Y<b.__webglFramebuffer.length;Y++)i.deleteFramebuffer(b.__webglFramebuffer[Y]);else i.deleteFramebuffer(b.__webglFramebuffer);if(b.__webglDepthbuffer&&i.deleteRenderbuffer(b.__webglDepthbuffer),b.__webglMultisampledFramebuffer&&i.deleteFramebuffer(b.__webglMultisampledFramebuffer),b.__webglColorRenderbuffer)for(let Y=0;Y<b.__webglColorRenderbuffer.length;Y++)b.__webglColorRenderbuffer[Y]&&i.deleteRenderbuffer(b.__webglColorRenderbuffer[Y]);b.__webglDepthRenderbuffer&&i.deleteRenderbuffer(b.__webglDepthRenderbuffer)}const k=T.textures;for(let Y=0,$=k.length;Y<$;Y++){const ne=n.get(k[Y]);ne.__webglTexture&&(i.deleteTexture(ne.__webglTexture),a.memory.textures--),n.remove(k[Y])}n.remove(T)}let z=0;function W(){z=0}function O(){return z}function P(T){z=T}function B(){const T=z;return T>=s.maxTextures&&Se("WebGLTextures: Trying to use "+T+" texture units while this GPU supports only "+s.maxTextures),z+=1,T}function U(T){const b=[];return b.push(T.wrapS),b.push(T.wrapT),b.push(T.wrapR||0),b.push(T.magFilter),b.push(T.minFilter),b.push(T.anisotropy),b.push(T.internalFormat),b.push(T.format),b.push(T.type),b.push(T.generateMipmaps),b.push(T.premultiplyAlpha),b.push(T.flipY),b.push(T.unpackAlignment),b.push(T.colorSpace),b.join()}function K(T,b){const k=n.get(T);if(T.isVideoTexture&&at(T),T.isRenderTargetTexture===!1&&T.isExternalTexture!==!0&&T.version>0&&k.__version!==T.version){const Y=T.image;if(Y===null)Se("WebGLRenderer: Texture marked for update but no image data found.");else if(Y.complete===!1)Se("WebGLRenderer: Texture marked for update but image is incomplete");else{ve(k,T,b);return}}else T.isExternalTexture&&(k.__webglTexture=T.sourceTexture?T.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,k.__webglTexture,i.TEXTURE0+b)}function Q(T,b){const k=n.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&k.__version!==T.version){ve(k,T,b);return}else T.isExternalTexture&&(k.__webglTexture=T.sourceTexture?T.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,k.__webglTexture,i.TEXTURE0+b)}function ee(T,b){const k=n.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&k.__version!==T.version){ve(k,T,b);return}t.bindTexture(i.TEXTURE_3D,k.__webglTexture,i.TEXTURE0+b)}function pe(T,b){const k=n.get(T);if(T.isCubeDepthTexture!==!0&&T.version>0&&k.__version!==T.version){Re(k,T,b);return}t.bindTexture(i.TEXTURE_CUBE_MAP,k.__webglTexture,i.TEXTURE0+b)}const xe={[Ki]:i.REPEAT,[vn]:i.CLAMP_TO_EDGE,[mr]:i.MIRRORED_REPEAT},We={[yt]:i.NEAREST,[Yl]:i.NEAREST_MIPMAP_NEAREST,[bs]:i.NEAREST_MIPMAP_LINEAR,[Et]:i.LINEAR,[cr]:i.LINEAR_MIPMAP_NEAREST,[kn]:i.LINEAR_MIPMAP_LINEAR},qe={[fd]:i.NEVER,[bd]:i.ALWAYS,[pd]:i.LESS,[No]:i.LEQUAL,[md]:i.EQUAL,[Uo]:i.GEQUAL,[gd]:i.GREATER,[_d]:i.NOTEQUAL};function we(T,b){if(b.type===sn&&e.has("OES_texture_float_linear")===!1&&(b.magFilter===Et||b.magFilter===cr||b.magFilter===bs||b.magFilter===kn||b.minFilter===Et||b.minFilter===cr||b.minFilter===bs||b.minFilter===kn)&&Se("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(T,i.TEXTURE_WRAP_S,xe[b.wrapS]),i.texParameteri(T,i.TEXTURE_WRAP_T,xe[b.wrapT]),(T===i.TEXTURE_3D||T===i.TEXTURE_2D_ARRAY)&&i.texParameteri(T,i.TEXTURE_WRAP_R,xe[b.wrapR]),i.texParameteri(T,i.TEXTURE_MAG_FILTER,We[b.magFilter]),i.texParameteri(T,i.TEXTURE_MIN_FILTER,We[b.minFilter]),b.compareFunction&&(i.texParameteri(T,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(T,i.TEXTURE_COMPARE_FUNC,qe[b.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(b.magFilter===yt||b.minFilter!==bs&&b.minFilter!==kn||b.type===sn&&e.has("OES_texture_float_linear")===!1)return;if(b.anisotropy>1||n.get(b).__currentAnisotropy){const k=e.get("EXT_texture_filter_anisotropic");i.texParameterf(T,k.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(b.anisotropy,s.getMaxAnisotropy())),n.get(b).__currentAnisotropy=b.anisotropy}}}function X(T,b){let k=!1;T.__webglInit===void 0&&(T.__webglInit=!0,b.addEventListener("dispose",A));const Y=b.source;let $=m.get(Y);$===void 0&&($={},m.set(Y,$));const ne=U(b);if(ne!==T.__cacheKey){$[ne]===void 0&&($[ne]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,k=!0),$[ne].usedTimes++;const oe=$[T.__cacheKey];oe!==void 0&&($[T.__cacheKey].usedTimes--,oe.usedTimes===0&&I(b)),T.__cacheKey=ne,T.__webglTexture=$[ne].texture}return k}function ce(T,b,k){return Math.floor(Math.floor(T/k)/b)}function te(T,b,k,Y){const ne=T.updateRanges;if(ne.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,b.width,b.height,k,Y,b.data);else{ne.sort((_e,re)=>_e.start-re.start);let oe=0;for(let _e=1;_e<ne.length;_e++){const re=ne[oe],ie=ne[_e],Le=re.start+re.count,Oe=ce(ie.start,b.width,4),Ye=ce(re.start,b.width,4);ie.start<=Le+1&&Oe===Ye&&ce(ie.start+ie.count-1,b.width,4)===Oe?re.count=Math.max(re.count,ie.start+ie.count-re.start):(++oe,ne[oe]=ie)}ne.length=oe+1;const j=t.getParameter(i.UNPACK_ROW_LENGTH),J=t.getParameter(i.UNPACK_SKIP_PIXELS),fe=t.getParameter(i.UNPACK_SKIP_ROWS);t.pixelStorei(i.UNPACK_ROW_LENGTH,b.width);for(let _e=0,re=ne.length;_e<re;_e++){const ie=ne[_e],Le=Math.floor(ie.start/4),Oe=Math.ceil(ie.count/4),Ye=Le%b.width,D=Math.floor(Le/b.width),se=Oe,q=1;t.pixelStorei(i.UNPACK_SKIP_PIXELS,Ye),t.pixelStorei(i.UNPACK_SKIP_ROWS,D),t.texSubImage2D(i.TEXTURE_2D,0,Ye,D,se,q,k,Y,b.data)}T.clearUpdateRanges(),t.pixelStorei(i.UNPACK_ROW_LENGTH,j),t.pixelStorei(i.UNPACK_SKIP_PIXELS,J),t.pixelStorei(i.UNPACK_SKIP_ROWS,fe)}}function ve(T,b,k){let Y=i.TEXTURE_2D;(b.isDataArrayTexture||b.isCompressedArrayTexture)&&(Y=i.TEXTURE_2D_ARRAY),b.isData3DTexture&&(Y=i.TEXTURE_3D);const $=X(T,b),ne=b.source;t.bindTexture(Y,T.__webglTexture,i.TEXTURE0+k);const oe=n.get(ne);if(ne.version!==oe.__version||$===!0){if(t.activeTexture(i.TEXTURE0+k),(typeof ImageBitmap<"u"&&b.image instanceof ImageBitmap)===!1){const q=He.getPrimaries(He.workingColorSpace),me=b.colorSpace===ni?null:He.getPrimaries(b.colorSpace),ae=b.colorSpace===ni||q===me?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,b.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,ae)}t.pixelStorei(i.UNPACK_ALIGNMENT,b.unpackAlignment);let J=p(b.image,!1,s.maxTextureSize);J=le(b,J);const fe=r.convert(b.format,b.colorSpace),_e=r.convert(b.type);let re=M(b.internalFormat,fe,_e,b.normalized,b.colorSpace,b.isVideoTexture);we(Y,b);let ie;const Le=b.mipmaps,Oe=b.isVideoTexture!==!0,Ye=oe.__version===void 0||$===!0,D=ne.dataReady,se=E(b,J);if(b.isDepthTexture)re=w(b.format===pi,b.type),Ye&&(Oe?t.texStorage2D(i.TEXTURE_2D,1,re,J.width,J.height):t.texImage2D(i.TEXTURE_2D,0,re,J.width,J.height,0,fe,_e,null));else if(b.isDataTexture)if(Le.length>0){Oe&&Ye&&t.texStorage2D(i.TEXTURE_2D,se,re,Le[0].width,Le[0].height);for(let q=0,me=Le.length;q<me;q++)ie=Le[q],Oe?D&&t.texSubImage2D(i.TEXTURE_2D,q,0,0,ie.width,ie.height,fe,_e,ie.data):t.texImage2D(i.TEXTURE_2D,q,re,ie.width,ie.height,0,fe,_e,ie.data);b.generateMipmaps=!1}else Oe?(Ye&&t.texStorage2D(i.TEXTURE_2D,se,re,J.width,J.height),D&&te(b,J,fe,_e)):t.texImage2D(i.TEXTURE_2D,0,re,J.width,J.height,0,fe,_e,J.data);else if(b.isCompressedTexture)if(b.isCompressedArrayTexture){Oe&&Ye&&t.texStorage3D(i.TEXTURE_2D_ARRAY,se,re,Le[0].width,Le[0].height,J.depth);for(let q=0,me=Le.length;q<me;q++)if(ie=Le[q],b.format!==rn)if(fe!==null)if(Oe){if(D)if(b.layerUpdates.size>0){const ae=cl(ie.width,ie.height,b.format,b.type);for(const Z of b.layerUpdates){const Ee=ie.data.subarray(Z*ae/ie.data.BYTES_PER_ELEMENT,(Z+1)*ae/ie.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,q,0,0,Z,ie.width,ie.height,1,fe,Ee)}b.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,q,0,0,0,ie.width,ie.height,J.depth,fe,ie.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,q,re,ie.width,ie.height,J.depth,0,ie.data,0,0);else Se("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Oe?D&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,q,0,0,0,ie.width,ie.height,J.depth,fe,_e,ie.data):t.texImage3D(i.TEXTURE_2D_ARRAY,q,re,ie.width,ie.height,J.depth,0,fe,_e,ie.data)}else{Oe&&Ye&&t.texStorage2D(i.TEXTURE_2D,se,re,Le[0].width,Le[0].height);for(let q=0,me=Le.length;q<me;q++)ie=Le[q],b.format!==rn?fe!==null?Oe?D&&t.compressedTexSubImage2D(i.TEXTURE_2D,q,0,0,ie.width,ie.height,fe,ie.data):t.compressedTexImage2D(i.TEXTURE_2D,q,re,ie.width,ie.height,0,ie.data):Se("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Oe?D&&t.texSubImage2D(i.TEXTURE_2D,q,0,0,ie.width,ie.height,fe,_e,ie.data):t.texImage2D(i.TEXTURE_2D,q,re,ie.width,ie.height,0,fe,_e,ie.data)}else if(b.isDataArrayTexture)if(Oe){if(Ye&&t.texStorage3D(i.TEXTURE_2D_ARRAY,se,re,J.width,J.height,J.depth),D)if(b.layerUpdates.size>0){const q=cl(J.width,J.height,b.format,b.type);for(const me of b.layerUpdates){const ae=J.data.subarray(me*q/J.data.BYTES_PER_ELEMENT,(me+1)*q/J.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,me,J.width,J.height,1,fe,_e,ae)}b.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,J.width,J.height,J.depth,fe,_e,J.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,re,J.width,J.height,J.depth,0,fe,_e,J.data);else if(b.isData3DTexture)Oe?(Ye&&t.texStorage3D(i.TEXTURE_3D,se,re,J.width,J.height,J.depth),D&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,J.width,J.height,J.depth,fe,_e,J.data)):t.texImage3D(i.TEXTURE_3D,0,re,J.width,J.height,J.depth,0,fe,_e,J.data);else if(b.isFramebufferTexture){if(Ye)if(Oe)t.texStorage2D(i.TEXTURE_2D,se,re,J.width,J.height);else{let q=J.width,me=J.height;for(let ae=0;ae<se;ae++)t.texImage2D(i.TEXTURE_2D,ae,re,q,me,0,fe,_e,null),q>>=1,me>>=1}}else if(b.isHTMLTexture){if("texElementImage2D"in i){const q=i.canvas;if(q.hasAttribute("layoutsubtree")||q.setAttribute("layoutsubtree","true"),J.parentNode!==q){q.appendChild(J),h.add(b),q.onpaint=Fe=>{const mt=Fe.changedElements;for(const et of h)mt.includes(et.image)&&(et.needsUpdate=!0)},q.requestPaint();return}const me=0,ae=i.RGBA,Z=i.RGBA,Ee=i.UNSIGNED_BYTE;i.texElementImage2D(i.TEXTURE_2D,me,ae,Z,Ee,J),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE)}}else if(Le.length>0){if(Oe&&Ye){const q=ft(Le[0]);t.texStorage2D(i.TEXTURE_2D,se,re,q.width,q.height)}for(let q=0,me=Le.length;q<me;q++)ie=Le[q],Oe?D&&t.texSubImage2D(i.TEXTURE_2D,q,0,0,fe,_e,ie):t.texImage2D(i.TEXTURE_2D,q,re,fe,_e,ie);b.generateMipmaps=!1}else if(Oe){if(Ye){const q=ft(J);t.texStorage2D(i.TEXTURE_2D,se,re,q.width,q.height)}D&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,fe,_e,J)}else t.texImage2D(i.TEXTURE_2D,0,re,fe,_e,J);f(b)&&_(Y),oe.__version=ne.version,b.onUpdate&&b.onUpdate(b)}T.__version=b.version}function Re(T,b,k){if(b.image.length!==6)return;const Y=X(T,b),$=b.source;t.bindTexture(i.TEXTURE_CUBE_MAP,T.__webglTexture,i.TEXTURE0+k);const ne=n.get($);if($.version!==ne.__version||Y===!0){t.activeTexture(i.TEXTURE0+k);const oe=He.getPrimaries(He.workingColorSpace),j=b.colorSpace===ni?null:He.getPrimaries(b.colorSpace),J=b.colorSpace===ni||oe===j?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,b.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),t.pixelStorei(i.UNPACK_ALIGNMENT,b.unpackAlignment),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,J);const fe=b.isCompressedTexture||b.image[0].isCompressedTexture,_e=b.image[0]&&b.image[0].isDataTexture,re=[];for(let Z=0;Z<6;Z++)!fe&&!_e?re[Z]=p(b.image[Z],!0,s.maxCubemapSize):re[Z]=_e?b.image[Z].image:b.image[Z],re[Z]=le(b,re[Z]);const ie=re[0],Le=r.convert(b.format,b.colorSpace),Oe=r.convert(b.type),Ye=M(b.internalFormat,Le,Oe,b.normalized,b.colorSpace),D=b.isVideoTexture!==!0,se=ne.__version===void 0||Y===!0,q=$.dataReady;let me=E(b,ie);we(i.TEXTURE_CUBE_MAP,b);let ae;if(fe){D&&se&&t.texStorage2D(i.TEXTURE_CUBE_MAP,me,Ye,ie.width,ie.height);for(let Z=0;Z<6;Z++){ae=re[Z].mipmaps;for(let Ee=0;Ee<ae.length;Ee++){const Fe=ae[Ee];b.format!==rn?Le!==null?D?q&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,Ee,0,0,Fe.width,Fe.height,Le,Fe.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,Ee,Ye,Fe.width,Fe.height,0,Fe.data):Se("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):D?q&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,Ee,0,0,Fe.width,Fe.height,Le,Oe,Fe.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,Ee,Ye,Fe.width,Fe.height,0,Le,Oe,Fe.data)}}}else{if(ae=b.mipmaps,D&&se){ae.length>0&&me++;const Z=ft(re[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,me,Ye,Z.width,Z.height)}for(let Z=0;Z<6;Z++)if(_e){D?q&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,0,0,re[Z].width,re[Z].height,Le,Oe,re[Z].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,Ye,re[Z].width,re[Z].height,0,Le,Oe,re[Z].data);for(let Ee=0;Ee<ae.length;Ee++){const mt=ae[Ee].image[Z].image;D?q&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,Ee+1,0,0,mt.width,mt.height,Le,Oe,mt.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,Ee+1,Ye,mt.width,mt.height,0,Le,Oe,mt.data)}}else{D?q&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,0,0,Le,Oe,re[Z]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,Ye,Le,Oe,re[Z]);for(let Ee=0;Ee<ae.length;Ee++){const Fe=ae[Ee];D?q&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,Ee+1,0,0,Le,Oe,Fe.image[Z]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Z,Ee+1,Ye,Le,Oe,Fe.image[Z])}}}f(b)&&_(i.TEXTURE_CUBE_MAP),ne.__version=$.version,b.onUpdate&&b.onUpdate(b)}T.__version=b.version}function ye(T,b,k,Y,$,ne){const oe=r.convert(k.format,k.colorSpace),j=r.convert(k.type),J=M(k.internalFormat,oe,j,k.normalized,k.colorSpace),fe=n.get(b),_e=n.get(k);if(_e.__renderTarget=b,!fe.__hasExternalTextures){const re=Math.max(1,b.width>>ne),ie=Math.max(1,b.height>>ne);$===i.TEXTURE_3D||$===i.TEXTURE_2D_ARRAY?t.texImage3D($,ne,J,re,ie,b.depth,0,oe,j,null):t.texImage2D($,ne,J,re,ie,0,oe,j,null)}t.bindFramebuffer(i.FRAMEBUFFER,T),Xe(b)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Y,$,_e.__webglTexture,0,Mt(b)):($===i.TEXTURE_2D||$>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&$<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,Y,$,_e.__webglTexture,ne),t.bindFramebuffer(i.FRAMEBUFFER,null)}function ct(T,b,k){if(i.bindRenderbuffer(i.RENDERBUFFER,T),b.depthBuffer){const Y=b.depthTexture,$=Y&&Y.isDepthTexture?Y.type:null,ne=w(b.stencilBuffer,$),oe=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;Xe(b)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Mt(b),ne,b.width,b.height):k?i.renderbufferStorageMultisample(i.RENDERBUFFER,Mt(b),ne,b.width,b.height):i.renderbufferStorage(i.RENDERBUFFER,ne,b.width,b.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,oe,i.RENDERBUFFER,T)}else{const Y=b.textures;for(let $=0;$<Y.length;$++){const ne=Y[$],oe=r.convert(ne.format,ne.colorSpace),j=r.convert(ne.type),J=M(ne.internalFormat,oe,j,ne.normalized,ne.colorSpace);Xe(b)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Mt(b),J,b.width,b.height):k?i.renderbufferStorageMultisample(i.RENDERBUFFER,Mt(b),J,b.width,b.height):i.renderbufferStorage(i.RENDERBUFFER,J,b.width,b.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Ge(T,b,k){const Y=b.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,T),!(b.depthTexture&&b.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const $=n.get(b.depthTexture);if($.__renderTarget=b,(!$.__webglTexture||b.depthTexture.image.width!==b.width||b.depthTexture.image.height!==b.height)&&(b.depthTexture.image.width=b.width,b.depthTexture.image.height=b.height,b.depthTexture.needsUpdate=!0),Y){if($.__webglInit===void 0&&($.__webglInit=!0,b.depthTexture.addEventListener("dispose",A)),$.__webglTexture===void 0){$.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,$.__webglTexture),we(i.TEXTURE_CUBE_MAP,b.depthTexture);const fe=r.convert(b.depthTexture.format),_e=r.convert(b.depthTexture.type);let re;b.depthTexture.format===Wn?re=i.DEPTH_COMPONENT24:b.depthTexture.format===pi&&(re=i.DEPTH24_STENCIL8);for(let ie=0;ie<6;ie++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ie,0,re,b.width,b.height,0,fe,_e,null)}}else K(b.depthTexture,0);const ne=$.__webglTexture,oe=Mt(b),j=Y?i.TEXTURE_CUBE_MAP_POSITIVE_X+k:i.TEXTURE_2D,J=b.depthTexture.format===pi?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(b.depthTexture.format===Wn)Xe(b)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,J,j,ne,0,oe):i.framebufferTexture2D(i.FRAMEBUFFER,J,j,ne,0);else if(b.depthTexture.format===pi)Xe(b)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,J,j,ne,0,oe):i.framebufferTexture2D(i.FRAMEBUFFER,J,j,ne,0);else throw new Error("Unknown depthTexture format")}function Qe(T){const b=n.get(T),k=T.isWebGLCubeRenderTarget===!0;if(b.__boundDepthTexture!==T.depthTexture){const Y=T.depthTexture;if(b.__depthDisposeCallback&&b.__depthDisposeCallback(),Y){const $=()=>{delete b.__boundDepthTexture,delete b.__depthDisposeCallback,Y.removeEventListener("dispose",$)};Y.addEventListener("dispose",$),b.__depthDisposeCallback=$}b.__boundDepthTexture=Y}if(T.depthTexture&&!b.__autoAllocateDepthBuffer)if(k)for(let Y=0;Y<6;Y++)Ge(b.__webglFramebuffer[Y],T,Y);else{const Y=T.texture.mipmaps;Y&&Y.length>0?Ge(b.__webglFramebuffer[0],T,0):Ge(b.__webglFramebuffer,T,0)}else if(k){b.__webglDepthbuffer=[];for(let Y=0;Y<6;Y++)if(t.bindFramebuffer(i.FRAMEBUFFER,b.__webglFramebuffer[Y]),b.__webglDepthbuffer[Y]===void 0)b.__webglDepthbuffer[Y]=i.createRenderbuffer(),ct(b.__webglDepthbuffer[Y],T,!1);else{const $=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ne=b.__webglDepthbuffer[Y];i.bindRenderbuffer(i.RENDERBUFFER,ne),i.framebufferRenderbuffer(i.FRAMEBUFFER,$,i.RENDERBUFFER,ne)}}else{const Y=T.texture.mipmaps;if(Y&&Y.length>0?t.bindFramebuffer(i.FRAMEBUFFER,b.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,b.__webglFramebuffer),b.__webglDepthbuffer===void 0)b.__webglDepthbuffer=i.createRenderbuffer(),ct(b.__webglDepthbuffer,T,!1);else{const $=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ne=b.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,ne),i.framebufferRenderbuffer(i.FRAMEBUFFER,$,i.RENDERBUFFER,ne)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function lt(T,b,k){const Y=n.get(T);b!==void 0&&ye(Y.__webglFramebuffer,T,T.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),k!==void 0&&Qe(T)}function je(T){const b=T.texture,k=n.get(T),Y=n.get(b);T.addEventListener("dispose",x);const $=T.textures,ne=T.isWebGLCubeRenderTarget===!0,oe=$.length>1;if(oe||(Y.__webglTexture===void 0&&(Y.__webglTexture=i.createTexture()),Y.__version=b.version,a.memory.textures++),ne){k.__webglFramebuffer=[];for(let j=0;j<6;j++)if(b.mipmaps&&b.mipmaps.length>0){k.__webglFramebuffer[j]=[];for(let J=0;J<b.mipmaps.length;J++)k.__webglFramebuffer[j][J]=i.createFramebuffer()}else k.__webglFramebuffer[j]=i.createFramebuffer()}else{if(b.mipmaps&&b.mipmaps.length>0){k.__webglFramebuffer=[];for(let j=0;j<b.mipmaps.length;j++)k.__webglFramebuffer[j]=i.createFramebuffer()}else k.__webglFramebuffer=i.createFramebuffer();if(oe)for(let j=0,J=$.length;j<J;j++){const fe=n.get($[j]);fe.__webglTexture===void 0&&(fe.__webglTexture=i.createTexture(),a.memory.textures++)}if(T.samples>0&&Xe(T)===!1){k.__webglMultisampledFramebuffer=i.createFramebuffer(),k.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,k.__webglMultisampledFramebuffer);for(let j=0;j<$.length;j++){const J=$[j];k.__webglColorRenderbuffer[j]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,k.__webglColorRenderbuffer[j]);const fe=r.convert(J.format,J.colorSpace),_e=r.convert(J.type),re=M(J.internalFormat,fe,_e,J.normalized,J.colorSpace,T.isXRRenderTarget===!0),ie=Mt(T);i.renderbufferStorageMultisample(i.RENDERBUFFER,ie,re,T.width,T.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+j,i.RENDERBUFFER,k.__webglColorRenderbuffer[j])}i.bindRenderbuffer(i.RENDERBUFFER,null),T.depthBuffer&&(k.__webglDepthRenderbuffer=i.createRenderbuffer(),ct(k.__webglDepthRenderbuffer,T,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(ne){t.bindTexture(i.TEXTURE_CUBE_MAP,Y.__webglTexture),we(i.TEXTURE_CUBE_MAP,b);for(let j=0;j<6;j++)if(b.mipmaps&&b.mipmaps.length>0)for(let J=0;J<b.mipmaps.length;J++)ye(k.__webglFramebuffer[j][J],T,b,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+j,J);else ye(k.__webglFramebuffer[j],T,b,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0);f(b)&&_(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(oe){for(let j=0,J=$.length;j<J;j++){const fe=$[j],_e=n.get(fe);let re=i.TEXTURE_2D;(T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(re=T.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(re,_e.__webglTexture),we(re,fe),ye(k.__webglFramebuffer,T,fe,i.COLOR_ATTACHMENT0+j,re,0),f(fe)&&_(re)}t.unbindTexture()}else{let j=i.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(j=T.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(j,Y.__webglTexture),we(j,b),b.mipmaps&&b.mipmaps.length>0)for(let J=0;J<b.mipmaps.length;J++)ye(k.__webglFramebuffer[J],T,b,i.COLOR_ATTACHMENT0,j,J);else ye(k.__webglFramebuffer,T,b,i.COLOR_ATTACHMENT0,j,0);f(b)&&_(j),t.unbindTexture()}T.depthBuffer&&Qe(T)}function vt(T){const b=T.textures;for(let k=0,Y=b.length;k<Y;k++){const $=b[k];if(f($)){const ne=y(T),oe=n.get($).__webglTexture;t.bindTexture(ne,oe),_(ne),t.unbindTexture()}}}const ht=[],jt=[];function F(T){if(T.samples>0){if(Xe(T)===!1){const b=T.textures,k=T.width,Y=T.height;let $=i.COLOR_BUFFER_BIT;const ne=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,oe=n.get(T),j=b.length>1;if(j)for(let fe=0;fe<b.length;fe++)t.bindFramebuffer(i.FRAMEBUFFER,oe.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+fe,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,oe.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+fe,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,oe.__webglMultisampledFramebuffer);const J=T.texture.mipmaps;J&&J.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,oe.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,oe.__webglFramebuffer);for(let fe=0;fe<b.length;fe++){if(T.resolveDepthBuffer&&(T.depthBuffer&&($|=i.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&($|=i.STENCIL_BUFFER_BIT)),j){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,oe.__webglColorRenderbuffer[fe]);const _e=n.get(b[fe]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,_e,0)}i.blitFramebuffer(0,0,k,Y,0,0,k,Y,$,i.NEAREST),c===!0&&(ht.length=0,jt.length=0,ht.push(i.COLOR_ATTACHMENT0+fe),T.depthBuffer&&T.resolveDepthBuffer===!1&&(ht.push(ne),jt.push(ne),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,jt)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,ht))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),j)for(let fe=0;fe<b.length;fe++){t.bindFramebuffer(i.FRAMEBUFFER,oe.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+fe,i.RENDERBUFFER,oe.__webglColorRenderbuffer[fe]);const _e=n.get(b[fe]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,oe.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+fe,i.TEXTURE_2D,_e,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,oe.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.resolveDepthBuffer===!1&&c){const b=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[b])}}}function Mt(T){return Math.min(s.maxSamples,T.samples)}function Xe(T){const b=n.get(T);return T.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&b.__useRenderToTexture!==!1}function at(T){const b=a.render.frame;d.get(T)!==b&&(d.set(T,b),T.update())}function le(T,b){const k=T.colorSpace,Y=T.format,$=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||k!==Vt&&k!==ni&&(He.getTransfer(k)===Je?(Y!==rn||$!==Jt)&&Se("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Ce("WebGLTextures: Unsupported texture color space:",k)),b}function ft(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(l.width=T.naturalWidth||T.width,l.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(l.width=T.displayWidth,l.height=T.displayHeight):(l.width=T.width,l.height=T.height),l}this.allocateTextureUnit=B,this.resetTextureUnits=W,this.getTextureUnits=O,this.setTextureUnits=P,this.setTexture2D=K,this.setTexture2DArray=Q,this.setTexture3D=ee,this.setTextureCube=pe,this.rebindTextures=lt,this.setupRenderTarget=je,this.updateRenderTargetMipmap=vt,this.updateMultisampleRenderTarget=F,this.setupDepthRenderbuffer=Qe,this.setupFrameBufferTexture=ye,this.useMultisampledRTT=Xe,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function V_(i,e){function t(n,s=ni){let r;const a=He.getTransfer(s);if(n===Jt)return i.UNSIGNED_BYTE;if(n===Co)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Po)return i.UNSIGNED_SHORT_5_5_5_1;if(n===$l)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Ql)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===Jl)return i.BYTE;if(n===Zl)return i.SHORT;if(n===ys)return i.UNSIGNED_SHORT;if(n===Ro)return i.INT;if(n===An)return i.UNSIGNED_INT;if(n===sn)return i.FLOAT;if(n===Vn)return i.HALF_FLOAT;if(n===eh)return i.ALPHA;if(n===th)return i.RGB;if(n===rn)return i.RGBA;if(n===Wn)return i.DEPTH_COMPONENT;if(n===pi)return i.DEPTH_STENCIL;if(n===Do)return i.RED;if(n===Lo)return i.RED_INTEGER;if(n===vi)return i.RG;if(n===Io)return i.RG_INTEGER;if(n===Fo)return i.RGBA_INTEGER;if(n===lr||n===hr||n===dr||n===ur)if(a===Je)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===lr)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===hr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===dr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===ur)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===lr)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===hr)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===dr)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===ur)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Fa||n===Na||n===Ua||n===Oa)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===Fa)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Na)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Ua)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Oa)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===ka||n===Ba||n===za||n===Ga||n===Ha||n===gr||n===Va)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===ka||n===Ba)return a===Je?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===za)return a===Je?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===Ga)return r.COMPRESSED_R11_EAC;if(n===Ha)return r.COMPRESSED_SIGNED_R11_EAC;if(n===gr)return r.COMPRESSED_RG11_EAC;if(n===Va)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===Wa||n===ja||n===Xa||n===qa||n===Ka||n===Ya||n===Ja||n===Za||n===$a||n===Qa||n===eo||n===to||n===no||n===io)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Wa)return a===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===ja)return a===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Xa)return a===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===qa)return a===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Ka)return a===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Ya)return a===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Ja)return a===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Za)return a===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===$a)return a===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Qa)return a===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===eo)return a===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===to)return a===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===no)return a===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===io)return a===Je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===so||n===ro||n===ao)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===so)return a===Je?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===ro)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===ao)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===oo||n===co||n===_r||n===lo)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===oo)return r.COMPRESSED_RED_RGTC1_EXT;if(n===co)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===_r)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===lo)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Es?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const W_=`
void main() {
